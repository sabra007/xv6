...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 f5 42 00 00       	call   801043e0 <acquire>
...
80100209:	e8 d2 41 00 00       	call   801043e0 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010028e:	e8 4d 41 00 00       	call   801043e0 <acquire>
  while(n > 0){
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 63 78 10 80 	movl   $0x80107863,(%esp)
...
80100409:	e8 42 56 00 00       	call   80105a50 <uartputc>
...
801004b9:	e8 92 55 00 00       	call   80105a50 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 86 55 00 00       	call   80105a50 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 7a 55 00 00       	call   80105a50 <uartputc>
...
8010060e:	e8 cd 3d 00 00       	call   801043e0 <acquire>
...
80100797:	e8 44 3c 00 00       	call   801043e0 <acquire>
...
801007c5:	e8 16 3c 00 00       	call   801043e0 <acquire>
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 0f 62 00 00       	call   80106c40 <setupkvm>
...
80100ad2:	e8 d9 5f 00 00       	call   80106ab0 <allocuvm>
...
80100b13:	e8 d8 5e 00 00       	call   801069f0 <loaduvm>
80100b18:	85 c0                	test   %eax,%eax
80100b1a:	0f 89 40 ff ff ff    	jns    80100a60 <exec+0xc0>
    freevm(pgdir);
80100b20:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b26:	89 04 24             	mov    %eax,(%esp)
80100b29:	e8 92 60 00 00       	call   80106bc0 <freevm>
...
80100b6c:	e8 3f 5f 00 00       	call   80106ab0 <allocuvm>
...
80100b84:	e8 37 60 00 00       	call   80106bc0 <freevm>
  return -1;
...
80100bc8:	e8 23 61 00 00       	call   80106cf0 <clearpteu>
...
80100c31:	e8 1a 62 00 00       	call   80106e50 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 a7 61 00 00       	call   80106e50 <copyout>
...
80100d1f:	e8 3c 5b 00 00       	call   80106860 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 94 5e 00 00       	call   80106bc0 <freevm>
  return 0;
...
80100d83:	e8 58 36 00 00       	call   801043e0 <acquire>
...
80100df1:	e8 ea 35 00 00       	call   801043e0 <acquire>
  if(f->ref < 1)
...
80100e43:	e8 98 35 00 00       	call   801043e0 <acquire>
  if(f->ref < 1)
...
80101164:	c3                   	ret    
    panic("freeing free block");
80101165:	c7 04 24 9f 6f 10 80 	movl   $0x80106f9f,(%esp)
...
80101225:	c7 04 24 b2 6f 10 80 	movl   $0x80106fb2,(%esp)
...
80101278:	e8 23 32 00 00       	call   801044a0 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 1f 31 00 00       	call   801043e0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 52 31 00 00       	call   80104450 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 0d 31 00 00       	call   80104450 <release>
}
...
8010134d:	c7 04 24 c8 6f 10 80 	movl   $0x80106fc8,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  panic("bmap: out of range");
80101407:	c7 04 24 d8 6f 10 80 	movl   $0x80106fd8,(%esp)
...
80101452:	e8 e9 30 00 00       	call   80104540 <memmove>
  brelse(bp);
...
8010147c:	c7 44 24 04 eb 6f 10 	movl   $0x80106feb,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 f2 6f 10 	movl   $0x80106ff2,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 58 70 10 80 	movl   $0x80107058,(%esp)
...
801015a9:	e8 f2 2e 00 00       	call   801044a0 <memset>
      dip->type = type;
...
801015e1:	c7 04 24 f8 6f 10 80 	movl   $0x80106ff8,(%esp)
...
8010165f:	00 
80101660:	e8 db 2e 00 00       	call   80104540 <memmove>
  log_write(bp);
...
80101691:	e8 4a 2d 00 00       	call   801043e0 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 aa 2d 00 00       	call   80104450 <release>
}
...
8010174b:	e8 f0 2d 00 00       	call   80104540 <memmove>
    brelse(bp);
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 10 70 10 80 	movl   $0x80107010,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 0a 70 10 80 	movl   $0x8010700a,(%esp)
...
801017a5:	e8 76 2a 00 00       	call   80104220 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 1d 2a 00 00       	jmp    801041e0 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 1f 70 10 80 	movl   $0x8010701f,(%esp)
...
801017e2:	e8 99 29 00 00       	call   80104180 <acquiresleep>
...
801017f8:	e8 e3 29 00 00       	call   801041e0 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 d7 2b 00 00       	call   801043e0 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 30 2c 00 00       	jmp    80104450 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 b4 2b 00 00       	call   801043e0 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 15 2c 00 00       	call   80104450 <release>
    if(r == 1){
...
80101a08:	e8 33 2b 00 00       	call   80104540 <memmove>
    brelse(bp);
...
80101b04:	e8 37 2a 00 00       	call   80104540 <memmove>
    log_write(bp);
...
80101bab:	e8 10 2a 00 00       	call   801045c0 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 92 29 00 00       	call   801045c0 <strncmp>
      continue;
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 39 70 10 80 	movl   $0x80107039,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 27 70 10 80 	movl   $0x80107027,(%esp)
...
80101ca8:	e8 33 27 00 00       	call   801043e0 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 93 27 00 00       	call   80104450 <release>
...
80101d1b:	e8 20 28 00 00       	call   80104540 <memmove>
    path++;
...
80101da9:	e8 92 27 00 00       	call   80104540 <memmove>
    name[len] = 0;
...
80101ea3:	e8 88 27 00 00       	call   80104630 <strncpy>
  de.inum = inum;
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 48 70 10 80 	movl   $0x80107048,(%esp)
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 4a 76 10 80 	movl   $0x8010764a,(%esp)
...
80101fdf:	c7 04 24 b4 70 10 80 	movl   $0x801070b4,(%esp)
80101fe6:	e8 75 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101feb:	c7 04 24 ab 70 10 80 	movl   $0x801070ab,(%esp)
...
80102006:	c7 44 24 04 c6 70 10 	movl   $0x801070c6,0x4(%esp)
8010200d:	80 
8010200e:	c7 04 24 80 a5 10 80 	movl   $0x8010a580,(%esp)
80102015:	e8 56 22 00 00       	call   80104270 <initlock>
...
80102090:	e8 4b 23 00 00       	call   801043e0 <acquire>
...
801020d6:	e8 75 23 00 00       	call   80104450 <release>
...
80102130:	e8 eb 20 00 00       	call   80104220 <holdingsleep>
...
80102166:	e8 75 22 00 00       	call   801043e0 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 85 22 00 00       	jmp    80104450 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
801021d9:	eb bb                	jmp    80102196 <iderw+0x76>
    panic("iderw: buf not locked");
801021db:	c7 04 24 ca 70 10 80 	movl   $0x801070ca,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 f5 70 10 80 	movl   $0x801070f5,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021f3:	c7 04 24 e0 70 10 80 	movl   $0x801070e0,(%esp)
...
80102248:	c7 04 24 14 71 10 80 	movl   $0x80107114,(%esp)
...
8010232a:	e8 71 21 00 00       	call   801044a0 <memset>
...
80102363:	5d                   	pop    %ebp
    release(&kmem.lock);
80102364:	e9 e7 20 00 00       	jmp    80104450 <release>
80102369:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&kmem.lock);
80102370:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
80102377:	e8 64 20 00 00       	call   801043e0 <acquire>
8010237c:	eb bb                	jmp    80102339 <kfree+0x49>
    panic("kfree");
8010237e:	c7 04 24 46 71 10 80 	movl   $0x80107146,(%esp)
...
801023eb:	c7 44 24 04 4c 71 10 	movl   $0x8010714c,0x4(%esp)
801023f2:	80 
801023f3:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
801023fa:	e8 71 1e 00 00       	call   80104270 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 7e 1f 00 00       	call   80104450 <release>
  return (char*)r;
}
...
801024e7:	e8 f4 1e 00 00       	call   801043e0 <acquire>
...
80102534:	0f b6 81 80 72 10 80 	movzbl -0x7fef8d80(%ecx),%eax
...
80102568:	0f b6 91 80 72 10 80 	movzbl -0x7fef8d80(%ecx),%edx
  shift ^= togglecode[data];
8010256f:	0f b6 81 80 71 10 80 	movzbl -0x7fef8e80(%ecx),%eax
  shift |= shiftcode[data];
...
8010257f:	8b 04 85 60 71 10 80 	mov    -0x7fef8ea0(,%eax,4),%eax
  shift ^= togglecode[data];
...
8010289c:	e8 4f 1c 00 00       	call   801044f0 <memcmp>
...
801029c7:	e8 74 1b 00 00       	call   80104540 <memmove>
...
80102a7b:	c7 44 24 04 80 73 10 	movl   $0x80107380,0x4(%esp)
80102a82:	80 
80102a83:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102a8a:	e8 e1 17 00 00       	call   80104270 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 be 18 00 00       	call   801043e0 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 e1 18 00 00       	call   80104450 <release>
      break;
    }
  }
}
...
80102b90:	e8 4b 18 00 00       	call   801043e0 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 80 18 00 00       	call   80104450 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 0c 19 00 00       	call   80104540 <memmove>
...
80102c74:	e8 67 17 00 00       	call   801043e0 <acquire>
    log.committing = 0;
...
80102c96:	e8 b5 17 00 00       	call   80104450 <release>
}
...
80102ca2:	c3                   	ret    
    panic("log.committing");
80102ca3:	c7 04 24 84 73 10 80 	movl   $0x80107384,(%esp)
...
80102ced:	e8 ee 16 00 00       	call   801043e0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 0c 17 00 00       	jmp    80104450 <release>
...
80102d5d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d60:	c7 04 24 93 73 10 80 	movl   $0x80107393,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d6c:	c7 04 24 a9 73 10 80 	movl   $0x801073a9,(%esp)
...
80102d97:	c7 04 24 c4 73 10 80 	movl   $0x801073c4,(%esp)
80102d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102da2:	e8 a9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102da7:	e8 c4 29 00 00       	call   80105770 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 65 3a 00 00       	call   80106840 <switchkvm>
  seginit();
80102ddb:	e8 a0 39 00 00       	call   80106780 <seginit>
  lapicinit();
...
80102e13:	e8 b8 3e 00 00       	call   80106cd0 <kvmalloc>
...
80102e25:	e8 56 39 00 00       	call   80106780 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 61 2c 00 00       	call   80105aa0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 ab 07 00 00       	call   801035f0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 86 28 00 00       	call   801056d0 <tvinit>
  binit();         // buffer cache
...
80102e71:	e8 ca 16 00 00       	call   80104540 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f3f:	00 
80102f40:	c7 44 24 04 d8 73 10 	movl   $0x801073d8,0x4(%esp)
80102f47:	80 
80102f48:	89 34 24             	mov    %esi,(%esp)
80102f4b:	e8 a0 15 00 00       	call   801044f0 <memcmp>
...
80102ffa:	00 
80102ffb:	c7 44 24 04 dd 73 10 	movl   $0x801073dd,0x4(%esp)
80103002:	80 
80103003:	89 04 24             	mov    %eax,(%esp)
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 e2 14 00 00       	call   801044f0 <memcmp>
...
8010308c:	ff 24 8d 1c 74 10 80 	jmp    *-0x7fef8be4(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 e2 73 10 80 	movl   $0x801073e2,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 fc 73 10 80 	movl   $0x801073fc,(%esp)
...
801031df:	c7 44 24 04 30 74 10 	movl   $0x80107430,0x4(%esp)
801031e6:	80 
801031e7:	e8 84 10 00 00       	call   80104270 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 6a 11 00 00       	call   801043e0 <acquire>
  if(writable){
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 9c 11 00 00       	jmp    80104450 <release>
...
801032db:	e8 70 11 00 00       	call   80104450 <release>
    kfree((char*)p);
...
80103382:	e8 c9 10 00 00       	call   80104450 <release>
        return -1;
...
801033d2:	e8 79 10 00 00       	call   80104450 <release>
  return n;
...
801033f2:	e8 e9 0f 00 00       	call   801043e0 <acquire>
...
8010344b:	e8 00 10 00 00       	call   80104450 <release>
...
801034ad:	e8 9e 0f 00 00       	call   80104450 <release>
}
...
801034d3:	e8 08 0f 00 00       	call   801043e0 <acquire>
...
80103505:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->priority = 15;
8010350c:	c7 83 80 00 00 00 0f 	movl   $0xf,0x80(%ebx)
80103513:	00 00 00 
  p->pid = nextpid++;
...
8010351f:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103522:	e8 29 0f 00 00       	call   80104450 <release>
...
8010353e:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103541:	c7 40 14 c1 56 10 80 	movl   $0x801056c1,0x14(%eax)
...
8010355b:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010355e:	e8 3d 0f 00 00       	call   801044a0 <memset>
...
801036b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036b7:	e8 34 0c 00 00       	call   801042f0 <pushcli>
  c = mycpu();
...
801036f3:	e8 48 35 00 00       	call   80106c40 <setupkvm>
...
80103715:	80 
80103716:	e8 55 32 00 00       	call   80106970 <inituvm>
  p->sz = PGSIZE;
...
801037b9:	e8 22 0c 00 00       	call   801043e0 <acquire>
  p->state = RUNNABLE;
...
80103819:	e8 92 32 00 00       	call   80106ab0 <allocuvm>
...
80103827:	e8 34 30 00 00       	call   80106860 <switchuvm>
  return 0;
...
8010384a:	e8 51 33 00 00       	call   80106ba0 <deallocuvm>
...
8010388e:	e8 8d 34 00 00       	call   80106d20 <copyuvm>
...
8010391c:	e8 bf 0a 00 00       	call   801043e0 <acquire>
  np->state = RUNNABLE;
...
8010397e:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
80103980:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103987:	00 00 00 
8010398a:	8d 70 04             	lea    0x4(%eax),%esi
  asm volatile("sti");
8010398d:	fb                   	sti    
    acquire(&ptable.lock);
8010398e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103995:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
8010399a:	e8 41 0a 00 00       	call   801043e0 <acquire>
8010399f:	eb 19                	jmp    801039ba <scheduler+0x4a>
801039a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039a8:	81 c7 84 00 00 00    	add    $0x84,%edi
801039ae:	81 ff 54 4e 11 80    	cmp    $0x80114e54,%edi
801039b4:	0f 83 84 00 00 00    	jae    80103a3e <scheduler+0xce>
      if(p->state != RUNNABLE)
801039ba:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
801039be:	75 e8                	jne    801039a8 <scheduler+0x38>
801039c0:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801039c5:	eb 0f                	jmp    801039d6 <scheduler+0x66>
801039c7:	90                   	nop
      for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
801039c8:	81 c2 84 00 00 00    	add    $0x84,%edx
801039ce:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801039d4:	74 23                	je     801039f9 <scheduler+0x89>
        if(p1->state != RUNNABLE)
801039d6:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
801039da:	75 ec                	jne    801039c8 <scheduler+0x58>
801039dc:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
801039e2:	39 82 80 00 00 00    	cmp    %eax,0x80(%edx)
801039e8:	0f 4c fa             	cmovl  %edx,%edi
      for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
801039eb:	81 c2 84 00 00 00    	add    $0x84,%edx
801039f1:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801039f7:	75 dd                	jne    801039d6 <scheduler+0x66>
      c->proc = p;
801039f9:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
801039ff:	89 3c 24             	mov    %edi,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a02:	81 c7 84 00 00 00    	add    $0x84,%edi
      switchuvm(p);
80103a08:	e8 53 2e 00 00       	call   80106860 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103a0d:	8b 47 98             	mov    -0x68(%edi),%eax
      p->state = RUNNING;
80103a10:	c7 47 88 04 00 00 00 	movl   $0x4,-0x78(%edi)
      swtch(&(c->scheduler), p->context);
80103a17:	89 34 24             	mov    %esi,(%esp)
80103a1a:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a1e:	e8 b8 0c 00 00       	call   801046db <swtch>
      switchkvm();
80103a23:	e8 18 2e 00 00       	call   80106840 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a28:	81 ff 54 4e 11 80    	cmp    $0x80114e54,%edi
      c->proc = 0;
80103a2e:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a35:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a38:	0f 82 7c ff ff ff    	jb     801039ba <scheduler+0x4a>
    release(&ptable.lock);
80103a3e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a45:	e8 06 0a 00 00       	call   80104450 <release>
  }
80103a4a:	e9 3e ff ff ff       	jmp    8010398d <scheduler+0x1d>
80103a4f:	90                   	nop
...
80103a64:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a66:	e8 35 09 00 00       	call   801043a0 <holding>
...
80103abe:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
80103ac5:	e8 96 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103aca:	c7 04 24 9c 74 10 80 	movl   $0x8010749c,(%esp)
80103ad1:	e8 8a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103ad6:	c7 04 24 8e 74 10 80 	movl   $0x8010748e,(%esp)
80103add:	e8 7e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103ae2:	c7 04 24 82 74 10 80 	movl   $0x80107482,(%esp)
...
80103aff:	89 c3                	mov    %eax,%ebx
  curproc->status = status;
80103b01:	8b 45 08             	mov    0x8(%ebp),%eax
  if(curproc == initproc)
80103b04:	3b 1d b8 a5 10 80    	cmp    0x8010a5b8,%ebx
  curproc->status = status;
80103b0a:	89 43 7c             	mov    %eax,0x7c(%ebx)
  if(curproc == initproc)
80103b0d:	0f 84 ff 00 00 00    	je     80103c12 <exit+0x122>
80103b13:	90                   	nop
80103b14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd]){
80103b18:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
80103b1c:	85 c0                	test   %eax,%eax
80103b1e:	74 10                	je     80103b30 <exit+0x40>
      fileclose(curproc->ofile[fd]);
80103b20:	89 04 24             	mov    %eax,(%esp)
80103b23:	e8 08 d3 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103b28:	c7 44 b3 28 00 00 00 	movl   $0x0,0x28(%ebx,%esi,4)
80103b2f:	00 
  for(fd = 0; fd < NOFILE; fd++){
80103b30:	83 c6 01             	add    $0x1,%esi
80103b33:	83 fe 10             	cmp    $0x10,%esi
80103b36:	75 e0                	jne    80103b18 <exit+0x28>
  begin_op();
80103b38:	e8 d3 ef ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80103b3d:	8b 43 68             	mov    0x68(%ebx),%eax
80103b40:	89 04 24             	mov    %eax,(%esp)
80103b43:	e8 88 dc ff ff       	call   801017d0 <iput>
  end_op();
80103b48:	e8 33 f0 ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80103b4d:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103b54:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b5b:	e8 80 08 00 00       	call   801043e0 <acquire>
  wakeup1(curproc->parent);
80103b60:	8b 43 14             	mov    0x14(%ebx),%eax
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103b63:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103b68:	eb 14                	jmp    80103b7e <exit+0x8e>
...
80103b7c:	74 20                	je     80103b9e <exit+0xae>
    if(p->state == SLEEPING && p->chan == chan)
80103b7e:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103b82:	75 ec                	jne    80103b70 <exit+0x80>
80103b84:	3b 42 20             	cmp    0x20(%edx),%eax
80103b87:	75 e7                	jne    80103b70 <exit+0x80>
      p->state = RUNNABLE;
...
80103b9c:	75 e0                	jne    80103b7e <exit+0x8e>
      p->parent = initproc;
80103b9e:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
80103ba3:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103ba8:	eb 14                	jmp    80103bbe <exit+0xce>
80103baa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bb0:	81 c1 84 00 00 00    	add    $0x84,%ecx
80103bb6:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
80103bbc:	74 3c                	je     80103bfa <exit+0x10a>
    if(p->parent == curproc){
80103bbe:	39 59 14             	cmp    %ebx,0x14(%ecx)
80103bc1:	75 ed                	jne    80103bb0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103bc3:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
      p->parent = initproc;
80103bc7:	89 41 14             	mov    %eax,0x14(%ecx)
      if(p->state == ZOMBIE)
80103bca:	75 e4                	jne    80103bb0 <exit+0xc0>
80103bcc:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103bd1:	eb 13                	jmp    80103be6 <exit+0xf6>
80103bd3:	90                   	nop
80103bd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bd8:	81 c2 84 00 00 00    	add    $0x84,%edx
80103bde:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103be4:	74 ca                	je     80103bb0 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103be6:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103bea:	75 ec                	jne    80103bd8 <exit+0xe8>
80103bec:	3b 42 20             	cmp    0x20(%edx),%eax
80103bef:	75 e7                	jne    80103bd8 <exit+0xe8>
      p->state = RUNNABLE;
80103bf1:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
80103bf8:	eb de                	jmp    80103bd8 <exit+0xe8>
  curproc->state = ZOMBIE;
80103bfa:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103c01:	e8 4a fe ff ff       	call   80103a50 <sched>
  panic("zombie exit");
80103c06:	c7 04 24 bd 74 10 80 	movl   $0x801074bd,(%esp)
80103c0d:	e8 4e c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103c12:	c7 04 24 b0 74 10 80 	movl   $0x801074b0,(%esp)
80103c19:	e8 42 c7 ff ff       	call   80100360 <panic>
...
80103c4a:	e8 01 08 00 00       	call   80104450 <release>
}
80103c4f:	c9                   	leave  
80103c50:	c3                   	ret    
...
80103c91:	e8 4a 07 00 00       	call   801043e0 <acquire>
    release(lk);
80103c96:	89 34 24             	mov    %esi,(%esp)
80103c99:	e8 b2 07 00 00       	call   80104450 <release>
  p->chan = chan;
...
80103cbb:	e8 90 07 00 00       	call   80104450 <release>
    acquire(lk);
...
80103cc9:	5d                   	pop    %ebp
    acquire(lk);
80103cca:	e9 11 07 00 00       	jmp    801043e0 <acquire>
80103ccf:	90                   	nop
  p->chan = chan;
...
80103cee:	c7 04 24 cf 74 10 80 	movl   $0x801074cf,(%esp)
80103cf5:	e8 66 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103cfa:	c7 04 24 c9 74 10 80 	movl   $0x801074c9,(%esp)
...
80103d19:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct proc *curproc = myproc();
80103d1c:	e8 8f f9 ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
80103d21:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103d28:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d2a:	e8 b1 06 00 00       	call   801043e0 <acquire>
    havekids = 0;
80103d2f:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d31:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103d36:	eb 0e                	jmp    80103d46 <wait+0x36>
80103d38:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103d3e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
80103d83:	eb aa                	jmp    80103d2f <wait+0x1f>
        if(status) {
80103d85:	85 ff                	test   %edi,%edi
80103d87:	74 05                	je     80103d8e <wait+0x7e>
	        *status = p->status;
80103d89:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103d8c:	89 07                	mov    %eax,(%edi)
        kfree(p->kstack);
80103d8e:	8b 43 08             	mov    0x8(%ebx),%eax
        pid = p->pid;
80103d91:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103d94:	89 04 24             	mov    %eax,(%esp)
80103d97:	e8 54 e5 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103d9c:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103d9f:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103da6:	89 04 24             	mov    %eax,(%esp)
80103da9:	e8 12 2e 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
80103dae:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103db5:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103dbc:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103dc3:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103dc7:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103dce:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103dd5:	e8 76 06 00 00       	call   80104450 <release>
}
80103dda:	83 c4 1c             	add    $0x1c,%esp
        return pid;
80103ddd:	89 f0                	mov    %esi,%eax
}
80103ddf:	5b                   	pop    %ebx
80103de0:	5e                   	pop    %esi
80103de1:	5f                   	pop    %edi
...
80103de3:	c3                   	ret    
      release(&ptable.lock);
80103de4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103deb:	e8 60 06 00 00       	call   80104450 <release>
}
80103df0:	83 c4 1c             	add    $0x1c,%esp
      return -1;
80103df3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103df8:	5b                   	pop    %ebx
80103df9:	5e                   	pop    %esi
80103dfa:	5f                   	pop    %edi
...
80103e11:	e8 ca 05 00 00       	call   801043e0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103e37:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e3e:	05 84 00 00 00       	add    $0x84,%eax
80103e43:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103e5b:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e5c:	e9 ef 05 00 00       	jmp    80104450 <release>
...
80103e81:	e8 5a 05 00 00       	call   801043e0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103eb5:	e8 96 05 00 00       	call   80104450 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103edf:	e8 6c 05 00 00       	call   80104450 <release>
}
...
80103f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f08:	c7 04 24 63 78 10 80 	movl   $0x80107863,(%esp)
80103f0f:	e8 3c c7 ff ff       	call   80100650 <cprintf>
80103f14:	81 c3 84 00 00 00    	add    $0x84,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f1a:	81 fb c0 4e 11 80    	cmp    $0x80114ec0,%ebx
...
80103f2d:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103f30:	ba e0 74 10 80       	mov    $0x801074e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f35:	77 11                	ja     80103f48 <procdump+0x58>
80103f37:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
      state = "???";
80103f3e:	b8 e0 74 10 80       	mov    $0x801074e0,%eax
...
80103f53:	c7 04 24 e4 74 10 80 	movl   $0x801074e4,(%esp)
...
80103f7f:	e8 0c 03 00 00       	call   80104290 <getcallerpcs>
...
80103f99:	c7 04 24 21 6f 10 80 	movl   $0x80106f21,(%esp)
...
80103fc9:	8b 75 08             	mov    0x8(%ebp),%esi
    ...
    struct proc *curproc = myproc();
80103fcc:	e8 df f6 ff ff       	call   801036b0 <myproc>
    acquire(&ptable.lock);
80103fd1:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    struct proc *curproc = myproc();
80103fd8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    acquire(&ptable.lock);
80103fdb:	e8 00 04 00 00       	call   801043e0 <acquire>
    for(;;) {
    // Scan through table looking for exited children.
    childPid = 0;
80103fe0:	31 c9                	xor    %ecx,%ecx
    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fe2:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103fe7:	eb 15                	jmp    80103ffe <waitpid+0x3e>
80103fe9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103ff0:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103ff6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103ffc:	74 20                	je     8010401e <waitpid+0x5e>
      if(p->pid != pid)  
80103ffe:	8b 7b 10             	mov    0x10(%ebx),%edi
80104001:	39 f7                	cmp    %esi,%edi
80104003:	75 eb                	jne    80103ff0 <waitpid+0x30>
        continue;
           
      childPid = 1;
      
      if(p->state == ZOMBIE){
80104005:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104009:	74 3d                	je     80104048 <waitpid+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010400b:	81 c3 84 00 00 00    	add    $0x84,%ebx
      childPid = 1;
80104011:	b9 01 00 00 00       	mov    $0x1,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104016:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010401c:	75 e0                	jne    80103ffe <waitpid+0x3e>
        release(&ptable.lock);
	      return pid;
    	}
    }
    
    if(!childPid || curproc->killed) {
8010401e:	85 c9                	test   %ecx,%ecx
80104020:	0f 84 87 00 00 00    	je     801040ad <waitpid+0xed>
80104026:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104029:	8b 40 24             	mov    0x24(%eax),%eax
8010402c:	85 c0                	test   %eax,%eax
8010402e:	75 7d                	jne    801040ad <waitpid+0xed>
      release(&ptable.lock);
      return -1;
    }
...
8010403e:	e8 1d fc ff ff       	call   80103c60 <sleep>
  }
80104043:	eb 9b                	jmp    80103fe0 <waitpid+0x20>
80104045:	8d 76 00             	lea    0x0(%esi),%esi
        if(status) {
80104048:	8b 55 0c             	mov    0xc(%ebp),%edx
8010404b:	85 d2                	test   %edx,%edx
8010404d:	74 0b                	je     8010405a <waitpid+0x9a>
          *status = p->status;
8010404f:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104052:	8b 55 0c             	mov    0xc(%ebp),%edx
80104055:	89 02                	mov    %eax,(%edx)
80104057:	8b 7b 10             	mov    0x10(%ebx),%edi
        kfree(p->kstack);
8010405a:	8b 53 08             	mov    0x8(%ebx),%edx
8010405d:	89 14 24             	mov    %edx,(%esp)
80104060:	e8 8b e2 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80104065:	8b 53 04             	mov    0x4(%ebx),%edx
        p->kstack = 0;
80104068:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010406f:	89 14 24             	mov    %edx,(%esp)
80104072:	e8 49 2b 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
...
80104097:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010409e:	e8 ad 03 00 00       	call   80104450 <release>
}
801040a3:	83 c4 1c             	add    $0x1c,%esp
...
801040ad:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
801040b4:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
801040b9:	e8 92 03 00 00       	call   80104450 <release>
      return -1;
801040be:	eb e3                	jmp    801040a3 <waitpid+0xe3>

801040c0 <changepriority>:
...
801040c8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801040cb:	e8 e0 f5 ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
801040d0:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
801040d7:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
801040d9:	e8 02 03 00 00       	call   801043e0 <acquire>
    
  if (priority > 15)
801040de:	83 fb 0f             	cmp    $0xf,%ebx
801040e1:	7f 25                	jg     80104108 <changepriority+0x48>
	  curproc->priority = 15;
  else if(priority <= 0)
	  curproc->priority = 15;
801040e3:	ba 0f 00 00 00       	mov    $0xf,%edx
801040e8:	85 db                	test   %ebx,%ebx
801040ea:	0f 4f d3             	cmovg  %ebx,%edx
801040ed:	89 96 80 00 00 00    	mov    %edx,0x80(%esi)
  else 
	  curproc->priority = priority;
  
  release(&ptable.lock);    
801040f3:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
...
801040ff:	5d                   	pop    %ebp
  release(&ptable.lock);    
80104100:	e9 4b 03 00 00       	jmp    80104450 <release>
80104105:	8d 76 00             	lea    0x0(%esi),%esi
	  curproc->priority = 15;
80104108:	c7 86 80 00 00 00 0f 	movl   $0xf,0x80(%esi)
8010410f:	00 00 00 
80104112:	eb df                	jmp    801040f3 <changepriority+0x33>
80104114:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010411a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80104120 <getpriority>:
...
80104123:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104126:	e8 85 f5 ff ff       	call   801036b0 <myproc>
  return curproc->priority;
8010412b:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
}
80104131:	c9                   	leave  
80104132:	c3                   	ret    
80104133:	66 90                	xchg   %ax,%ax
...
8010414a:	c7 44 24 04 58 75 10 	movl   $0x80107558,0x4(%esp)
80104151:	80 
80104152:	8d 43 04             	lea    0x4(%ebx),%eax
80104155:	89 04 24             	mov    %eax,(%esp)
80104158:	e8 13 01 00 00       	call   80104270 <initlock>
  lk->name = name;
...
80104191:	e8 4a 02 00 00       	call   801043e0 <acquire>
  while (lk->locked) {
...
801041a7:	e8 b4 fa ff ff       	call   80103c60 <sleep>
  while (lk->locked) {
...
801041b2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041b8:	e8 f3 f4 ff ff       	call   801036b0 <myproc>
...
801041cb:	5d                   	pop    %ebp
  release(&lk->lk);
801041cc:	e9 7f 02 00 00       	jmp    80104450 <release>
...
801041f1:	e8 ea 01 00 00       	call   801043e0 <acquire>
  lk->locked = 0;
...
80104206:	e8 f5 fb ff ff       	call   80103e00 <wakeup>
  release(&lk->lk);
...
80104213:	5d                   	pop    %ebp
  release(&lk->lk);
80104214:	e9 37 02 00 00       	jmp    80104450 <release>
...
80104224:	31 ff                	xor    %edi,%edi
{
80104226:	56                   	push   %esi
80104227:	53                   	push   %ebx
80104228:	83 ec 1c             	sub    $0x1c,%esp
8010422b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
8010422e:	8d 73 04             	lea    0x4(%ebx),%esi
80104231:	89 34 24             	mov    %esi,(%esp)
80104234:	e8 a7 01 00 00       	call   801043e0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104239:	8b 03                	mov    (%ebx),%eax
8010423b:	85 c0                	test   %eax,%eax
8010423d:	74 13                	je     80104252 <holdingsleep+0x32>
8010423f:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104242:	e8 69 f4 ff ff       	call   801036b0 <myproc>
80104247:	3b 58 10             	cmp    0x10(%eax),%ebx
8010424a:	0f 94 c0             	sete   %al
8010424d:	0f b6 c0             	movzbl %al,%eax
80104250:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
80104252:	89 34 24             	mov    %esi,(%esp)
80104255:	e8 f6 01 00 00       	call   80104450 <release>
  return r;
}
8010425a:	83 c4 1c             	add    $0x1c,%esp
8010425d:	89 f8                	mov    %edi,%eax
8010425f:	5b                   	pop    %ebx
80104260:	5e                   	pop    %esi
80104261:	5f                   	pop    %edi
80104262:	5d                   	pop    %ebp
80104263:	c3                   	ret    
80104264:	66 90                	xchg   %ax,%ax
...
80104379:	c3                   	ret    
    panic("popcli");
8010437a:	c7 04 24 7a 75 10 80 	movl   $0x8010757a,(%esp)
80104381:	e8 da bf ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104386:	c7 04 24 63 75 10 80 	movl   $0x80107563,(%esp)
...
801043aa:	e8 41 ff ff ff       	call   801042f0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801043af:	8b 03                	mov    (%ebx),%eax
801043b1:	85 c0                	test   %eax,%eax
801043b3:	74 12                	je     801043c7 <holding+0x27>
801043b5:	8b 5b 08             	mov    0x8(%ebx),%ebx
801043b8:	e8 53 f2 ff ff       	call   80103610 <mycpu>
801043bd:	39 c3                	cmp    %eax,%ebx
801043bf:	0f 94 c0             	sete   %al
801043c2:	0f b6 c0             	movzbl %al,%eax
801043c5:	89 c6                	mov    %eax,%esi
  popcli();
801043c7:	e8 64 ff ff ff       	call   80104330 <popcli>
}
...
801043e7:	e8 04 ff ff ff       	call   801042f0 <pushcli>
  if(holding(lk))
801043ec:	8b 45 08             	mov    0x8(%ebp),%eax
801043ef:	89 04 24             	mov    %eax,(%esp)
801043f2:	e8 a9 ff ff ff       	call   801043a0 <holding>
801043f7:	85 c0                	test   %eax,%eax
801043f9:	75 3a                	jne    80104435 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
...
8010440a:	75 f4                	jne    80104400 <acquire+0x20>
  __sync_synchronize();
8010440c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010440f:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104412:	e8 f9 f1 ff ff       	call   80103610 <mycpu>
80104417:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010441a:	8b 45 08             	mov    0x8(%ebp),%eax
8010441d:	83 c0 0c             	add    $0xc,%eax
80104420:	89 44 24 04          	mov    %eax,0x4(%esp)
80104424:	8d 45 08             	lea    0x8(%ebp),%eax
80104427:	89 04 24             	mov    %eax,(%esp)
8010442a:	e8 61 fe ff ff       	call   80104290 <getcallerpcs>
}
...
80104434:	c3                   	ret    
    panic("acquire");
80104435:	c7 04 24 81 75 10 80 	movl   $0x80107581,(%esp)
8010443c:	e8 1f bf ff ff       	call   80100360 <panic>
...
80104457:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
8010445a:	89 1c 24             	mov    %ebx,(%esp)
8010445d:	e8 3e ff ff ff       	call   801043a0 <holding>
80104462:	85 c0                	test   %eax,%eax
80104464:	74 21                	je     80104487 <release+0x37>
  lk->pcs[0] = 0;
80104466:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
8010446d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104474:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104477:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010447d:	83 c4 14             	add    $0x14,%esp
80104480:	5b                   	pop    %ebx
80104481:	5d                   	pop    %ebp
  popcli();
80104482:	e9 a9 fe ff ff       	jmp    80104330 <popcli>
    panic("release");
80104487:	c7 04 24 89 75 10 80 	movl   $0x80107589,(%esp)
8010448e:	e8 cd be ff ff       	call   80100360 <panic>
...
80104878:	83 fa 17             	cmp    $0x17,%edx
8010487b:	77 1b                	ja     80104898 <syscall+0x38>
8010487d:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
...
801048a6:	c7 04 24 91 75 10 80 	movl   $0x80107591,(%esp)
...
80104916:	83 ec 3c             	sub    $0x3c,%esp
80104919:	89 4d d0             	mov    %ecx,-0x30(%ebp)
...
{
80104929:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010492c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010492f:	e8 ec d5 ff ff       	call   80101f20 <nameiparent>
...
80104941:	e8 6a cd ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104946:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010494d:	00 
8010494e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104952:	89 3c 24             	mov    %edi,(%esp)
80104955:	e8 66 d2 ff ff       	call   80101bc0 <dirlookup>
8010495a:	85 c0                	test   %eax,%eax
8010495c:	89 c6                	mov    %eax,%esi
8010495e:	74 40                	je     801049a0 <create+0x90>
    iunlockput(dp);
80104960:	89 3c 24             	mov    %edi,(%esp)
80104963:	e8 a8 cf ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104968:	89 34 24             	mov    %esi,(%esp)
8010496b:	e8 40 cd ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104970:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104975:	75 11                	jne    80104988 <create+0x78>
80104977:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010497c:	89 f0                	mov    %esi,%eax
8010497e:	75 08                	jne    80104988 <create+0x78>
...
8010498b:	e8 80 cf ff ff       	call   80101910 <iunlockput>
}
...
801049ad:	e8 6e cb ff ff       	call   80101520 <ialloc>
...
801049bf:	e8 ec cc ff ff       	call   801016b0 <ilock>
  ip->major = major;
801049c4:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
801049c8:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801049cc:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
...
801049e0:	e8 0b cc ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801049e5:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
...
80104a0b:	83 c4 3c             	add    $0x3c,%esp
  return ip;
...
80104a61:	79 89                	jns    801049ec <create+0xdc>
      panic("create dots");
80104a63:	c7 04 24 33 76 10 80 	movl   $0x80107633,(%esp)
80104a6a:	e8 f1 b8 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104a6f:	c7 04 24 42 76 10 80 	movl   $0x80107642,(%esp)
80104a76:	e8 e5 b8 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104a7b:	c7 04 24 24 76 10 80 	movl   $0x80107624,(%esp)
...
80104ce9:	0f 88 cb 00 00 00    	js     80104dba <sys_link+0x10a>
  begin_op();
80104cef:	e8 1c de ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104cf4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104cf7:	89 04 24             	mov    %eax,(%esp)
80104cfa:	e8 01 d2 ff ff       	call   80101f00 <namei>
...
80104d27:	e8 c4 c8 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104d2c:	89 1c 24             	mov    %ebx,(%esp)
80104d2f:	e8 5c ca ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104d34:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104d37:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104d3b:	89 04 24             	mov    %eax,(%esp)
80104d3e:	e8 dd d1 ff ff       	call   80101f20 <nameiparent>
...
80104d65:	e8 b6 d0 ff ff       	call   80101e20 <dirlink>
80104d6a:	85 c0                	test   %eax,%eax
80104d6c:	78 22                	js     80104d90 <sys_link+0xe0>
  iunlockput(dp);
80104d6e:	89 34 24             	mov    %esi,(%esp)
80104d71:	e8 9a cb ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104d76:	89 1c 24             	mov    %ebx,(%esp)
80104d79:	e8 52 ca ff ff       	call   801017d0 <iput>
  end_op();
80104d7e:	e8 fd dd ff ff       	call   80102b80 <end_op>
}
...
80104d9b:	e8 10 c9 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
...
80104dee:	0f 88 76 01 00 00    	js     80104f6a <sys_unlink+0x19a>
  begin_op();
80104df4:	e8 17 dd ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104e06:	e8 15 d1 ff ff       	call   80101f20 <nameiparent>
...
80104e21:	c7 44 24 04 40 76 10 	movl   $0x80107640,0x4(%esp)
80104e28:	80 
80104e29:	89 1c 24             	mov    %ebx,(%esp)
80104e2c:	e8 5f cd ff ff       	call   80101b90 <namecmp>
80104e31:	85 c0                	test   %eax,%eax
80104e33:	0f 84 21 01 00 00    	je     80104f5a <sys_unlink+0x18a>
80104e39:	c7 44 24 04 3f 76 10 	movl   $0x8010763f,0x4(%esp)
80104e40:	80 
80104e41:	89 1c 24             	mov    %ebx,(%esp)
80104e44:	e8 47 cd ff ff       	call   80101b90 <namecmp>
...
80104e5f:	e8 5c cd ff ff       	call   80101bc0 <dirlookup>
...
80104e71:	e8 3a c8 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
...
80104ebc:	e8 9f cb ff ff       	call   80101a60 <writei>
...
80104ef0:	e8 1b ca ff ff       	call   80101910 <iunlockput>
  end_op();
80104ef5:	e8 86 dc ff ff       	call   80102b80 <end_op>
}
...
80104f41:	e8 1a ca ff ff       	call   80101960 <readi>
...
80104f55:	e8 b6 c9 ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
80104f5a:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104f5d:	89 04 24             	mov    %eax,(%esp)
80104f60:	e8 ab c9 ff ff       	call   80101910 <iunlockput>
  end_op();
80104f65:	e8 16 dc ff ff       	call   80102b80 <end_op>
}
...
80104f83:	e8 68 c6 ff ff       	call   801015f0 <iupdate>
80104f88:	e9 48 ff ff ff       	jmp    80104ed5 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104f8d:	c7 04 24 64 76 10 80 	movl   $0x80107664,(%esp)
80104f94:	e8 c7 b3 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104f99:	c7 04 24 76 76 10 80 	movl   $0x80107676,(%esp)
80104fa0:	e8 bb b3 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104fa5:	c7 04 24 52 76 10 80 	movl   $0x80107652,(%esp)
...
80105014:	e8 e7 ce ff ff       	call   80101f00 <namei>
...
80105026:	e8 85 c6 ff ff       	call   801016b0 <ilock>
...
80105057:	e8 34 c7 ff ff       	call   80101790 <iunlock>
  end_op();
8010505c:	e8 1f db ff ff       	call   80102b80 <end_op>
...
801050ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801050b0:	e8 cb da ff ff       	call   80102b80 <end_op>
}
...
801050db:	e8 30 c8 ff ff       	call   80101910 <iunlockput>
...
80105103:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105106:	e8 05 da ff ff       	call   80102b10 <begin_op>
...
80105163:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105166:	e8 a5 d9 ff ff       	call   80102b10 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801051cf:	e8 3c c7 ff ff       	call   80101910 <iunlockput>
  end_op();
801051d4:	e8 a7 d9 ff ff       	call   80102b80 <end_op>
  return 0;
...
801051dd:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
801051e0:	e8 9b d9 ff ff       	call   80102b80 <end_op>
    return -1;
...
801051fd:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
801051ff:	e8 0c d9 ff ff       	call   80102b10 <begin_op>
...
80105221:	e8 da cc ff ff       	call   80101f00 <namei>
...
8010522f:	e8 7c c4 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
8010523c:	75 22                	jne    80105260 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010523e:	e8 4d c5 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105243:	8b 46 68             	mov    0x68(%esi),%eax
80105246:	89 04 24             	mov    %eax,(%esp)
80105249:	e8 82 c5 ff ff       	call   801017d0 <iput>
  end_op();
8010524e:	e8 2d d9 ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
...
8010525f:	90                   	nop
    iunlockput(ip);
80105260:	e8 ab c6 ff ff       	call   80101910 <iunlockput>
    end_op();
80105265:	e8 16 d9 ff ff       	call   80102b80 <end_op>
}
...
801053a3:	e8 c8 dd ff ff       	call   80103170 <pipealloc>
...
80105434:	e8 57 f3 ff ff       	call   80104790 <argint>
  exit(status);
80105439:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010543c:	89 04 24             	mov    %eax,(%esp)
8010543f:	e8 ac e6 ff ff       	call   80103af0 <exit>
...
80105453:	83 ec 28             	sub    $0x28,%esp
  int *temp;
  argptr(0, (char**)&temp, sizeof(temp)); 
...
8010546c:	e8 4f f3 ff ff       	call   801047c0 <argptr>
  return wait(temp);
80105471:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105474:	89 04 24             	mov    %eax,(%esp)
80105477:	e8 94 e8 ff ff       	call   80103d10 <wait>
}
8010547c:	c9                   	leave  
8010547d:	c3                   	ret    
...
80105494:	e8 f7 f2 ff ff       	call   80104790 <argint>
80105499:	85 c0                	test   %eax,%eax
8010549b:	78 13                	js     801054b0 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010549d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054a0:	89 04 24             	mov    %eax,(%esp)
801054a3:	e8 c8 e9 ff ff       	call   80103e70 <kill>
}
801054a8:	c9                   	leave  
801054a9:	c3                   	ret    
...
801054c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801054c6:	e8 e5 e1 ff ff       	call   801036b0 <myproc>
...
801054e5:	e8 a6 f2 ff ff       	call   80104790 <argint>
801054ea:	85 c0                	test   %eax,%eax
801054ec:	78 22                	js     80105510 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801054ee:	e8 bd e1 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
801054f3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
801054f6:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801054f8:	89 14 24             	mov    %edx,(%esp)
801054fb:	e8 f0 e2 ff ff       	call   801037f0 <growproc>
80105500:	85 c0                	test   %eax,%eax
80105502:	78 0c                	js     80105510 <sys_sbrk+0x40>
    return -1;
  return addr;
80105504:	89 d8                	mov    %ebx,%eax
}
80105506:	83 c4 24             	add    $0x24,%esp
80105509:	5b                   	pop    %ebx
8010550a:	5d                   	pop    %ebp
8010550b:	c3                   	ret    
...
80105515:	eb ef                	jmp    80105506 <sys_sbrk+0x36>
...
80105535:	e8 56 f2 ff ff       	call   80104790 <argint>
8010553a:	85 c0                	test   %eax,%eax
8010553c:	78 7e                	js     801055bc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010553e:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105545:	e8 96 ee ff ff       	call   801043e0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010554a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010554d:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
80105553:	85 d2                	test   %edx,%edx
80105555:	75 29                	jne    80105580 <sys_sleep+0x60>
80105557:	eb 4f                	jmp    801055a8 <sys_sleep+0x88>
...
80105560:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
80105567:	80 
80105568:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
8010556f:	e8 ec e6 ff ff       	call   80103c60 <sleep>
  while(ticks - ticks0 < n){
80105574:	a1 a0 56 11 80       	mov    0x801156a0,%eax
80105579:	29 d8                	sub    %ebx,%eax
8010557b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010557e:	73 28                	jae    801055a8 <sys_sleep+0x88>
    if(myproc()->killed){
80105580:	e8 2b e1 ff ff       	call   801036b0 <myproc>
80105585:	8b 40 24             	mov    0x24(%eax),%eax
80105588:	85 c0                	test   %eax,%eax
8010558a:	74 d4                	je     80105560 <sys_sleep+0x40>
      release(&tickslock);
8010558c:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105593:	e8 b8 ee ff ff       	call   80104450 <release>
      return -1;
...
8010559d:	83 c4 24             	add    $0x24,%esp
801055a0:	5b                   	pop    %ebx
801055a1:	5d                   	pop    %ebp
801055a2:	c3                   	ret    
801055a3:	90                   	nop
801055a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801055a8:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801055af:	e8 9c ee ff ff       	call   80104450 <release>
}
801055b4:	83 c4 24             	add    $0x24,%esp
  return 0;
...
801055c1:	eb da                	jmp    8010559d <sys_sleep+0x7d>
...
801055d4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801055d7:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801055de:	e8 fd ed ff ff       	call   801043e0 <acquire>
  xticks = ticks;
801055e3:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
801055e9:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801055f0:	e8 5b ee ff ff       	call   80104450 <release>
  return xticks;
}
801055f5:	83 c4 14             	add    $0x14,%esp
801055f8:	89 d8                	mov    %ebx,%eax
801055fa:	5b                   	pop    %ebx
801055fb:	5d                   	pop    %ebp
801055fc:	c3                   	ret    
801055fd:	8d 76 00             	lea    0x0(%esi),%esi

80105600 <sys_waitpid>:
...
80105603:	83 ec 28             	sub    $0x28,%esp
  ...
  argint(0, &pid);
80105606:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105609:	89 44 24 04          	mov    %eax,0x4(%esp)
8010560d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105614:	e8 77 f1 ff ff       	call   80104790 <argint>
  argptr(1, (char**)&status, sizeof(status));  
80105619:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010561c:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105623:	00 
80105624:	89 44 24 04          	mov    %eax,0x4(%esp)
80105628:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010562f:	e8 8c f1 ff ff       	call   801047c0 <argptr>
  argint(2, &options);
80105634:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105637:	89 44 24 04          	mov    %eax,0x4(%esp)
8010563b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105642:	e8 49 f1 ff ff       	call   80104790 <argint>
...
8010565b:	e8 60 e9 ff ff       	call   80103fc0 <waitpid>
}
80105660:	c9                   	leave  
80105661:	c3                   	ret    
80105662:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105669:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105670 <sys_changepriority>:
...
80105684:	e8 07 f1 ff ff       	call   80104790 <argint>
  changepriority(priority);
80105689:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010568c:	89 04 24             	mov    %eax,(%esp)
8010568f:	e8 2c ea ff ff       	call   801040c0 <changepriority>
  return 0;
 }
...
801056a3:	5d                   	pop    %ebp
	return getpriority();
801056a4:	e9 77 ea ff ff       	jmp    80104120 <getpriority>
...
801056aa:	06                   	push   %es
  pushl %fs
801056ab:	0f a0                	push   %fs
  pushl %gs
801056ad:	0f a8                	push   %gs
  pushal
801056af:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056b0:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056b4:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056b6:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801056b8:	54                   	push   %esp
  call trap
801056b9:	e8 e2 00 00 00       	call   801057a0 <trap>
  addl $4, %esp
801056be:	83 c4 04             	add    $0x4,%esp
...
801056c1:	61                   	popa   
  popl %gs
801056c2:	0f a9                	pop    %gs
  popl %fs
801056c4:	0f a1                	pop    %fs
  popl %es
801056c6:	07                   	pop    %es
  popl %ds
801056c7:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801056c8:	83 c4 08             	add    $0x8,%esp
  iret
801056cb:	cf                   	iret   
...
801056e4:	66 89 0c c5 a2 4e 11 	mov    %cx,-0x7feeb15e(,%eax,8)
801056eb:	80 
801056ec:	c6 04 c5 a4 4e 11 80 	movb   $0x0,-0x7feeb15c(,%eax,8)
801056f3:	00 
801056f4:	c6 04 c5 a5 4e 11 80 	movb   $0x8e,-0x7feeb15b(,%eax,8)
801056fb:	8e 
801056fc:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105703:	80 
80105704:	c1 ea 10             	shr    $0x10,%edx
80105707:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
8010570e:	80 
  for(i = 0; i < 256; i++)
...
80105721:	83 ec 18             	sub    $0x18,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105724:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105729:	c7 44 24 04 85 76 10 	movl   $0x80107685,0x4(%esp)
80105730:	80 
80105731:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105738:	66 89 15 a2 50 11 80 	mov    %dx,0x801150a2
8010573f:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105745:	c1 e8 10             	shr    $0x10,%eax
80105748:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
8010574f:	c6 05 a5 50 11 80 ef 	movb   $0xef,0x801150a5
80105756:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
8010575c:	e8 0f eb ff ff       	call   80104270 <initlock>
}
80105761:	c9                   	leave  
80105762:	c3                   	ret    
80105763:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
8010577b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010577f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
801057be:	77 08                	ja     801057c8 <trap+0x28>
801057c0:	ff 24 85 2c 77 10 80 	jmp    *-0x7fef88d4(,%eax,4)
801057c7:	90                   	nop
    lapiceoi();
    break;
...
801057c8:	e8 e3 de ff ff       	call   801036b0 <myproc>
801057cd:	85 c0                	test   %eax,%eax
801057cf:	90                   	nop
801057d0:	0f 84 0a 02 00 00    	je     801059e0 <trap+0x240>
801057d6:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801057da:	0f 84 00 02 00 00    	je     801059e0 <trap+0x240>
...
801057e3:	8b 53 38             	mov    0x38(%ebx),%edx
801057e6:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801057e9:	89 55 dc             	mov    %edx,-0x24(%ebp)
801057ec:	e8 9f de ff ff       	call   80103690 <cpuid>
801057f1:	8b 73 30             	mov    0x30(%ebx),%esi
801057f4:	89 c7                	mov    %eax,%edi
801057f6:	8b 43 34             	mov    0x34(%ebx),%eax
801057f9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801057fc:	e8 af de ff ff       	call   801036b0 <myproc>
80105801:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105804:	e8 a7 de ff ff       	call   801036b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105809:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010580c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105810:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105813:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105816:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010581a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010581e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105821:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105824:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105828:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010582c:	89 54 24 10          	mov    %edx,0x10(%esp)
80105830:	8b 40 10             	mov    0x10(%eax),%eax
80105833:	c7 04 24 e8 76 10 80 	movl   $0x801076e8,(%esp)
8010583a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010583e:	e8 0d ae ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105843:	e8 68 de ff ff       	call   801036b0 <myproc>
80105848:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010584f:	90                   	nop
  }
...
80105850:	e8 5b de ff ff       	call   801036b0 <myproc>
80105855:	85 c0                	test   %eax,%eax
80105857:	74 0c                	je     80105865 <trap+0xc5>
80105859:	e8 52 de ff ff       	call   801036b0 <myproc>
8010585e:	8b 50 24             	mov    0x24(%eax),%edx
80105861:	85 d2                	test   %edx,%edx
80105863:	75 4b                	jne    801058b0 <trap+0x110>
    exit(0);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105865:	e8 46 de ff ff       	call   801036b0 <myproc>
8010586a:	85 c0                	test   %eax,%eax
8010586c:	74 0d                	je     8010587b <trap+0xdb>
8010586e:	66 90                	xchg   %ax,%ax
80105870:	e8 3b de ff ff       	call   801036b0 <myproc>
80105875:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105879:	74 55                	je     801058d0 <trap+0x130>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010587b:	e8 30 de ff ff       	call   801036b0 <myproc>
80105880:	85 c0                	test   %eax,%eax
80105882:	74 1d                	je     801058a1 <trap+0x101>
80105884:	e8 27 de ff ff       	call   801036b0 <myproc>
80105889:	8b 40 24             	mov    0x24(%eax),%eax
8010588c:	85 c0                	test   %eax,%eax
8010588e:	74 11                	je     801058a1 <trap+0x101>
80105890:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105894:	83 e0 03             	and    $0x3,%eax
80105897:	66 83 f8 03          	cmp    $0x3,%ax
8010589b:	0f 84 e8 00 00 00    	je     80105989 <trap+0x1e9>
    exit(0);
}
801058a1:	83 c4 3c             	add    $0x3c,%esp
801058a4:	5b                   	pop    %ebx
801058a5:	5e                   	pop    %esi
801058a6:	5f                   	pop    %edi
801058a7:	5d                   	pop    %ebp
...
801058a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058b0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801058b4:	83 e0 03             	and    $0x3,%eax
801058b7:	66 83 f8 03          	cmp    $0x3,%ax
801058bb:	75 a8                	jne    80105865 <trap+0xc5>
    exit(0);
801058bd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058c4:	e8 27 e2 ff ff       	call   80103af0 <exit>
801058c9:	eb 9a                	jmp    80105865 <trap+0xc5>
801058cb:	90                   	nop
801058cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
801058d0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801058d4:	75 a5                	jne    8010587b <trap+0xdb>
    yield();
801058d6:	e8 45 e3 ff ff       	call   80103c20 <yield>
801058db:	eb 9e                	jmp    8010587b <trap+0xdb>
801058dd:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801058e0:	e8 ab dd ff ff       	call   80103690 <cpuid>
801058e5:	85 c0                	test   %eax,%eax
801058e7:	0f 84 c3 00 00 00    	je     801059b0 <trap+0x210>
801058ed:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801058f0:	e8 8b ce ff ff       	call   80102780 <lapiceoi>
    break;
801058f5:	e9 56 ff ff ff       	jmp    80105850 <trap+0xb0>
801058fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    kbdintr();
80105900:	e8 cb cc ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105905:	e8 76 ce ff ff       	call   80102780 <lapiceoi>
    break;
8010590a:	e9 41 ff ff ff       	jmp    80105850 <trap+0xb0>
8010590f:	90                   	nop
    uartintr();
80105910:	e8 2b 02 00 00       	call   80105b40 <uartintr>
    lapiceoi();
80105915:	e8 66 ce ff ff       	call   80102780 <lapiceoi>
    break;
8010591a:	e9 31 ff ff ff       	jmp    80105850 <trap+0xb0>
8010591f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105920:	8b 7b 38             	mov    0x38(%ebx),%edi
80105923:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105927:	e8 64 dd ff ff       	call   80103690 <cpuid>
8010592c:	c7 04 24 90 76 10 80 	movl   $0x80107690,(%esp)
80105933:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80105937:	89 74 24 08          	mov    %esi,0x8(%esp)
8010593b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010593f:	e8 0c ad ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105944:	e8 37 ce ff ff       	call   80102780 <lapiceoi>
    break;
80105949:	e9 02 ff ff ff       	jmp    80105850 <trap+0xb0>
8010594e:	66 90                	xchg   %ax,%ax
    ideintr();
80105950:	e8 2b c7 ff ff       	call   80102080 <ideintr>
80105955:	eb 96                	jmp    801058ed <trap+0x14d>
80105957:	90                   	nop
80105958:	90                   	nop
80105959:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105960:	e8 4b dd ff ff       	call   801036b0 <myproc>
80105965:	8b 70 24             	mov    0x24(%eax),%esi
80105968:	85 f6                	test   %esi,%esi
8010596a:	75 34                	jne    801059a0 <trap+0x200>
    myproc()->tf = tf;
8010596c:	e8 3f dd ff ff       	call   801036b0 <myproc>
80105971:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105974:	e8 e7 ee ff ff       	call   80104860 <syscall>
    if(myproc()->killed)
80105979:	e8 32 dd ff ff       	call   801036b0 <myproc>
8010597e:	8b 48 24             	mov    0x24(%eax),%ecx
80105981:	85 c9                	test   %ecx,%ecx
80105983:	0f 84 18 ff ff ff    	je     801058a1 <trap+0x101>
      exit(0);
80105989:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
80105990:	83 c4 3c             	add    $0x3c,%esp
80105993:	5b                   	pop    %ebx
80105994:	5e                   	pop    %esi
80105995:	5f                   	pop    %edi
80105996:	5d                   	pop    %ebp
      exit(0);
80105997:	e9 54 e1 ff ff       	jmp    80103af0 <exit>
8010599c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit(0);
801059a0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059a7:	e8 44 e1 ff ff       	call   80103af0 <exit>
801059ac:	eb be                	jmp    8010596c <trap+0x1cc>
801059ae:	66 90                	xchg   %ax,%ax
      acquire(&tickslock);
801059b0:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801059b7:	e8 24 ea ff ff       	call   801043e0 <acquire>
      wakeup(&ticks);
801059bc:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
801059c3:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
801059ca:	e8 31 e4 ff ff       	call   80103e00 <wakeup>
      release(&tickslock);
801059cf:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801059d6:	e8 75 ea ff ff       	call   80104450 <release>
801059db:	e9 0d ff ff ff       	jmp    801058ed <trap+0x14d>
801059e0:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059e3:	8b 73 38             	mov    0x38(%ebx),%esi
801059e6:	e8 a5 dc ff ff       	call   80103690 <cpuid>
801059eb:	89 7c 24 10          	mov    %edi,0x10(%esp)
801059ef:	89 74 24 0c          	mov    %esi,0xc(%esp)
801059f3:	89 44 24 08          	mov    %eax,0x8(%esp)
801059f7:	8b 43 30             	mov    0x30(%ebx),%eax
801059fa:	c7 04 24 b4 76 10 80 	movl   $0x801076b4,(%esp)
80105a01:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a05:	e8 46 ac ff ff       	call   80100650 <cprintf>
      panic("trap");
80105a0a:	c7 04 24 8a 76 10 80 	movl   $0x8010768a,(%esp)
80105a11:	e8 4a a9 ff ff       	call   80100360 <panic>
...
80105a2a:	74 14                	je     80105a40 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80105a34:	74 0a                	je     80105a40 <uartgetc+0x20>
80105a36:	b2 f8                	mov    $0xf8,%dl
...
80105a57:	74 3f                	je     80105a98 <uartputc+0x48>
{
...
80105a62:	53                   	push   %ebx
  if(!uart)
80105a63:	bb 80 00 00 00       	mov    $0x80,%ebx
{
80105a68:	83 ec 10             	sub    $0x10,%esp
80105a6b:	eb 14                	jmp    80105a81 <uartputc+0x31>
80105a6d:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80105a70:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80105a77:	e8 24 cd ff ff       	call   801027a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105a7c:	83 eb 01             	sub    $0x1,%ebx
80105a7f:	74 07                	je     80105a88 <uartputc+0x38>
80105a81:	89 f2                	mov    %esi,%edx
80105a83:	ec                   	in     (%dx),%al
80105a84:	a8 20                	test   $0x20,%al
80105a86:	74 e8                	je     80105a70 <uartputc+0x20>
  outb(COM1+0, c);
80105a88:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105a8c:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105aa5:	89 c8                	mov    %ecx,%eax
80105aa7:	57                   	push   %edi
80105aa8:	bf fa 03 00 00       	mov    $0x3fa,%edi
80105aad:	56                   	push   %esi
80105aae:	89 fa                	mov    %edi,%edx
80105ab0:	53                   	push   %ebx
80105ab1:	83 ec 1c             	sub    $0x1c,%esp
80105ab4:	ee                   	out    %al,(%dx)
80105ab5:	be fb 03 00 00       	mov    $0x3fb,%esi
80105aba:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105abf:	89 f2                	mov    %esi,%edx
80105ac1:	ee                   	out    %al,(%dx)
80105ac2:	b8 0c 00 00 00       	mov    $0xc,%eax
80105ac7:	b2 f8                	mov    $0xf8,%dl
80105ac9:	ee                   	out    %al,(%dx)
80105aca:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105acf:	89 c8                	mov    %ecx,%eax
80105ad1:	89 da                	mov    %ebx,%edx
80105ad3:	ee                   	out    %al,(%dx)
80105ad4:	b8 03 00 00 00       	mov    $0x3,%eax
80105ad9:	89 f2                	mov    %esi,%edx
80105adb:	ee                   	out    %al,(%dx)
80105adc:	b2 fc                	mov    $0xfc,%dl
80105ade:	89 c8                	mov    %ecx,%eax
80105ae0:	ee                   	out    %al,(%dx)
80105ae1:	b8 01 00 00 00       	mov    $0x1,%eax
80105ae6:	89 da                	mov    %ebx,%edx
80105ae8:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105ae9:	b2 fd                	mov    $0xfd,%dl
80105aeb:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105aec:	3c ff                	cmp    $0xff,%al
80105aee:	74 42                	je     80105b32 <uartinit+0x92>
  uart = 1;
80105af0:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105af7:	00 00 00 
80105afa:	89 fa                	mov    %edi,%edx
80105afc:	ec                   	in     (%dx),%al
80105afd:	b2 f8                	mov    $0xf8,%dl
80105aff:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105b00:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b07:	00 
  for(p="xv6...\n"; *p; p++)
80105b08:	bb ac 77 10 80       	mov    $0x801077ac,%ebx
  ioapicenable(IRQ_COM1, 0);
80105b0d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105b14:	e8 97 c7 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105b20:	89 04 24             	mov    %eax,(%esp)
  for(p="xv6...\n"; *p; p++)
80105b23:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105b26:	e8 25 ff ff ff       	call   80105a50 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105b2b:	0f be 03             	movsbl (%ebx),%eax
80105b2e:	84 c0                	test   %al,%al
80105b30:	75 ee                	jne    80105b20 <uartinit+0x80>
}
80105b32:	83 c4 1c             	add    $0x1c,%esp
80105b35:	5b                   	pop    %ebx
80105b36:	5e                   	pop    %esi
80105b37:	5f                   	pop    %edi
80105b38:	5d                   	pop    %ebp
...
80105b46:	c7 04 24 20 5a 10 80 	movl   $0x80105a20,(%esp)
80105b4d:	e8 5e ac ff ff       	call   801007b0 <consoleintr>
}
80105b52:	c9                   	leave  
80105b53:	c3                   	ret    
...
80105b56:	6a 00                	push   $0x0
  jmp alltraps
80105b58:	e9 4c fb ff ff       	jmp    801056a9 <alltraps>
...
80105b5f:	6a 01                	push   $0x1
  jmp alltraps
80105b61:	e9 43 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b68:	6a 02                	push   $0x2
  jmp alltraps
80105b6a:	e9 3a fb ff ff       	jmp    801056a9 <alltraps>
...
80105b6f:	6a 00                	push   $0x0
  pushl $3
80105b71:	6a 03                	push   $0x3
  jmp alltraps
80105b73:	e9 31 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b7a:	6a 04                	push   $0x4
  jmp alltraps
80105b7c:	e9 28 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b81:	6a 00                	push   $0x0
  pushl $5
80105b83:	6a 05                	push   $0x5
  jmp alltraps
80105b85:	e9 1f fb ff ff       	jmp    801056a9 <alltraps>
...
80105b8a:	6a 00                	push   $0x0
  pushl $6
80105b8c:	6a 06                	push   $0x6
  jmp alltraps
80105b8e:	e9 16 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b93:	6a 00                	push   $0x0
  pushl $7
80105b95:	6a 07                	push   $0x7
  jmp alltraps
80105b97:	e9 0d fb ff ff       	jmp    801056a9 <alltraps>
...
80105b9c:	6a 08                	push   $0x8
  jmp alltraps
80105b9e:	e9 06 fb ff ff       	jmp    801056a9 <alltraps>
...
80105ba3:	6a 00                	push   $0x0
  pushl $9
80105ba5:	6a 09                	push   $0x9
  jmp alltraps
80105ba7:	e9 fd fa ff ff       	jmp    801056a9 <alltraps>

80105bac <vector10>:
.globl vector10
vector10:
  pushl $10
80105bac:	6a 0a                	push   $0xa
  jmp alltraps
80105bae:	e9 f6 fa ff ff       	jmp    801056a9 <alltraps>

80105bb3 <vector11>:
.globl vector11
vector11:
  pushl $11
80105bb3:	6a 0b                	push   $0xb
  jmp alltraps
80105bb5:	e9 ef fa ff ff       	jmp    801056a9 <alltraps>

80105bba <vector12>:
.globl vector12
vector12:
  pushl $12
80105bba:	6a 0c                	push   $0xc
  jmp alltraps
80105bbc:	e9 e8 fa ff ff       	jmp    801056a9 <alltraps>

80105bc1 <vector13>:
.globl vector13
vector13:
  pushl $13
80105bc1:	6a 0d                	push   $0xd
  jmp alltraps
80105bc3:	e9 e1 fa ff ff       	jmp    801056a9 <alltraps>

80105bc8 <vector14>:
.globl vector14
vector14:
  pushl $14
80105bc8:	6a 0e                	push   $0xe
  jmp alltraps
80105bca:	e9 da fa ff ff       	jmp    801056a9 <alltraps>
...
80105bcf:	6a 00                	push   $0x0
  pushl $15
80105bd1:	6a 0f                	push   $0xf
  jmp alltraps
80105bd3:	e9 d1 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bda:	6a 10                	push   $0x10
  jmp alltraps
80105bdc:	e9 c8 fa ff ff       	jmp    801056a9 <alltraps>

80105be1 <vector17>:
.globl vector17
vector17:
  pushl $17
80105be1:	6a 11                	push   $0x11
  jmp alltraps
80105be3:	e9 c1 fa ff ff       	jmp    801056a9 <alltraps>
...
80105be8:	6a 00                	push   $0x0
  pushl $18
80105bea:	6a 12                	push   $0x12
  jmp alltraps
80105bec:	e9 b8 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bf1:	6a 00                	push   $0x0
  pushl $19
80105bf3:	6a 13                	push   $0x13
  jmp alltraps
80105bf5:	e9 af fa ff ff       	jmp    801056a9 <alltraps>
...
80105bfa:	6a 00                	push   $0x0
  pushl $20
80105bfc:	6a 14                	push   $0x14
  jmp alltraps
80105bfe:	e9 a6 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c03:	6a 00                	push   $0x0
  pushl $21
80105c05:	6a 15                	push   $0x15
  jmp alltraps
80105c07:	e9 9d fa ff ff       	jmp    801056a9 <alltraps>
...
80105c0c:	6a 00                	push   $0x0
  pushl $22
80105c0e:	6a 16                	push   $0x16
  jmp alltraps
80105c10:	e9 94 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c15:	6a 00                	push   $0x0
  pushl $23
80105c17:	6a 17                	push   $0x17
  jmp alltraps
80105c19:	e9 8b fa ff ff       	jmp    801056a9 <alltraps>
...
80105c1e:	6a 00                	push   $0x0
  pushl $24
80105c20:	6a 18                	push   $0x18
  jmp alltraps
80105c22:	e9 82 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c27:	6a 00                	push   $0x0
  pushl $25
80105c29:	6a 19                	push   $0x19
  jmp alltraps
80105c2b:	e9 79 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c30:	6a 00                	push   $0x0
  pushl $26
80105c32:	6a 1a                	push   $0x1a
  jmp alltraps
80105c34:	e9 70 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c39:	6a 00                	push   $0x0
  pushl $27
80105c3b:	6a 1b                	push   $0x1b
  jmp alltraps
80105c3d:	e9 67 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c42:	6a 00                	push   $0x0
  pushl $28
80105c44:	6a 1c                	push   $0x1c
  jmp alltraps
80105c46:	e9 5e fa ff ff       	jmp    801056a9 <alltraps>
...
80105c4b:	6a 00                	push   $0x0
  pushl $29
80105c4d:	6a 1d                	push   $0x1d
  jmp alltraps
80105c4f:	e9 55 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c54:	6a 00                	push   $0x0
  pushl $30
80105c56:	6a 1e                	push   $0x1e
  jmp alltraps
80105c58:	e9 4c fa ff ff       	jmp    801056a9 <alltraps>
...
80105c5d:	6a 00                	push   $0x0
  pushl $31
80105c5f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c61:	e9 43 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c66:	6a 00                	push   $0x0
  pushl $32
80105c68:	6a 20                	push   $0x20
  jmp alltraps
80105c6a:	e9 3a fa ff ff       	jmp    801056a9 <alltraps>
...
80105c6f:	6a 00                	push   $0x0
  pushl $33
80105c71:	6a 21                	push   $0x21
  jmp alltraps
80105c73:	e9 31 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c78:	6a 00                	push   $0x0
  pushl $34
80105c7a:	6a 22                	push   $0x22
  jmp alltraps
80105c7c:	e9 28 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c81:	6a 00                	push   $0x0
  pushl $35
80105c83:	6a 23                	push   $0x23
  jmp alltraps
80105c85:	e9 1f fa ff ff       	jmp    801056a9 <alltraps>
...
80105c8a:	6a 00                	push   $0x0
  pushl $36
80105c8c:	6a 24                	push   $0x24
  jmp alltraps
80105c8e:	e9 16 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c93:	6a 00                	push   $0x0
  pushl $37
80105c95:	6a 25                	push   $0x25
  jmp alltraps
80105c97:	e9 0d fa ff ff       	jmp    801056a9 <alltraps>
...
80105c9c:	6a 00                	push   $0x0
  pushl $38
80105c9e:	6a 26                	push   $0x26
  jmp alltraps
80105ca0:	e9 04 fa ff ff       	jmp    801056a9 <alltraps>
...
80105ca5:	6a 00                	push   $0x0
  pushl $39
80105ca7:	6a 27                	push   $0x27
  jmp alltraps
80105ca9:	e9 fb f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cae:	6a 00                	push   $0x0
  pushl $40
80105cb0:	6a 28                	push   $0x28
  jmp alltraps
80105cb2:	e9 f2 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cb7:	6a 00                	push   $0x0
  pushl $41
80105cb9:	6a 29                	push   $0x29
  jmp alltraps
80105cbb:	e9 e9 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cc0:	6a 00                	push   $0x0
  pushl $42
80105cc2:	6a 2a                	push   $0x2a
  jmp alltraps
80105cc4:	e9 e0 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cc9:	6a 00                	push   $0x0
  pushl $43
80105ccb:	6a 2b                	push   $0x2b
  jmp alltraps
80105ccd:	e9 d7 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cd2:	6a 00                	push   $0x0
  pushl $44
80105cd4:	6a 2c                	push   $0x2c
  jmp alltraps
80105cd6:	e9 ce f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cdb:	6a 00                	push   $0x0
  pushl $45
80105cdd:	6a 2d                	push   $0x2d
  jmp alltraps
80105cdf:	e9 c5 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105ce4:	6a 00                	push   $0x0
  pushl $46
80105ce6:	6a 2e                	push   $0x2e
  jmp alltraps
80105ce8:	e9 bc f9 ff ff       	jmp    801056a9 <alltraps>
...
80105ced:	6a 00                	push   $0x0
  pushl $47
80105cef:	6a 2f                	push   $0x2f
  jmp alltraps
80105cf1:	e9 b3 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cf6:	6a 00                	push   $0x0
  pushl $48
80105cf8:	6a 30                	push   $0x30
  jmp alltraps
80105cfa:	e9 aa f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cff:	6a 00                	push   $0x0
  pushl $49
80105d01:	6a 31                	push   $0x31
  jmp alltraps
80105d03:	e9 a1 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d08:	6a 00                	push   $0x0
  pushl $50
80105d0a:	6a 32                	push   $0x32
  jmp alltraps
80105d0c:	e9 98 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d11:	6a 00                	push   $0x0
  pushl $51
80105d13:	6a 33                	push   $0x33
  jmp alltraps
80105d15:	e9 8f f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d1a:	6a 00                	push   $0x0
  pushl $52
80105d1c:	6a 34                	push   $0x34
  jmp alltraps
80105d1e:	e9 86 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d23:	6a 00                	push   $0x0
  pushl $53
80105d25:	6a 35                	push   $0x35
  jmp alltraps
80105d27:	e9 7d f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d2c:	6a 00                	push   $0x0
  pushl $54
80105d2e:	6a 36                	push   $0x36
  jmp alltraps
80105d30:	e9 74 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d35:	6a 00                	push   $0x0
  pushl $55
80105d37:	6a 37                	push   $0x37
  jmp alltraps
80105d39:	e9 6b f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d3e:	6a 00                	push   $0x0
  pushl $56
80105d40:	6a 38                	push   $0x38
  jmp alltraps
80105d42:	e9 62 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d47:	6a 00                	push   $0x0
  pushl $57
80105d49:	6a 39                	push   $0x39
  jmp alltraps
80105d4b:	e9 59 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d50:	6a 00                	push   $0x0
  pushl $58
80105d52:	6a 3a                	push   $0x3a
  jmp alltraps
80105d54:	e9 50 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d59:	6a 00                	push   $0x0
  pushl $59
80105d5b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d5d:	e9 47 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d62:	6a 00                	push   $0x0
  pushl $60
80105d64:	6a 3c                	push   $0x3c
  jmp alltraps
80105d66:	e9 3e f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d6b:	6a 00                	push   $0x0
  pushl $61
80105d6d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d6f:	e9 35 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d74:	6a 00                	push   $0x0
  pushl $62
80105d76:	6a 3e                	push   $0x3e
  jmp alltraps
80105d78:	e9 2c f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d7d:	6a 00                	push   $0x0
  pushl $63
80105d7f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d81:	e9 23 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d86:	6a 00                	push   $0x0
  pushl $64
80105d88:	6a 40                	push   $0x40
  jmp alltraps
80105d8a:	e9 1a f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d8f:	6a 00                	push   $0x0
  pushl $65
80105d91:	6a 41                	push   $0x41
  jmp alltraps
80105d93:	e9 11 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d98:	6a 00                	push   $0x0
  pushl $66
80105d9a:	6a 42                	push   $0x42
  jmp alltraps
80105d9c:	e9 08 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105da1:	6a 00                	push   $0x0
  pushl $67
80105da3:	6a 43                	push   $0x43
  jmp alltraps
80105da5:	e9 ff f8 ff ff       	jmp    801056a9 <alltraps>
...
80105daa:	6a 00                	push   $0x0
  pushl $68
80105dac:	6a 44                	push   $0x44
  jmp alltraps
80105dae:	e9 f6 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105db3:	6a 00                	push   $0x0
  pushl $69
80105db5:	6a 45                	push   $0x45
  jmp alltraps
80105db7:	e9 ed f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dbc:	6a 00                	push   $0x0
  pushl $70
80105dbe:	6a 46                	push   $0x46
  jmp alltraps
80105dc0:	e9 e4 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dc5:	6a 00                	push   $0x0
  pushl $71
80105dc7:	6a 47                	push   $0x47
  jmp alltraps
80105dc9:	e9 db f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dce:	6a 00                	push   $0x0
  pushl $72
80105dd0:	6a 48                	push   $0x48
  jmp alltraps
80105dd2:	e9 d2 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dd7:	6a 00                	push   $0x0
  pushl $73
80105dd9:	6a 49                	push   $0x49
  jmp alltraps
80105ddb:	e9 c9 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105de0:	6a 00                	push   $0x0
  pushl $74
80105de2:	6a 4a                	push   $0x4a
  jmp alltraps
80105de4:	e9 c0 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105de9:	6a 00                	push   $0x0
  pushl $75
80105deb:	6a 4b                	push   $0x4b
  jmp alltraps
80105ded:	e9 b7 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105df2:	6a 00                	push   $0x0
  pushl $76
80105df4:	6a 4c                	push   $0x4c
  jmp alltraps
80105df6:	e9 ae f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dfb:	6a 00                	push   $0x0
  pushl $77
80105dfd:	6a 4d                	push   $0x4d
  jmp alltraps
80105dff:	e9 a5 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e04:	6a 00                	push   $0x0
  pushl $78
80105e06:	6a 4e                	push   $0x4e
  jmp alltraps
80105e08:	e9 9c f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e0d:	6a 00                	push   $0x0
  pushl $79
80105e0f:	6a 4f                	push   $0x4f
  jmp alltraps
80105e11:	e9 93 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e16:	6a 00                	push   $0x0
  pushl $80
80105e18:	6a 50                	push   $0x50
  jmp alltraps
80105e1a:	e9 8a f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e1f:	6a 00                	push   $0x0
  pushl $81
80105e21:	6a 51                	push   $0x51
  jmp alltraps
80105e23:	e9 81 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e28:	6a 00                	push   $0x0
  pushl $82
80105e2a:	6a 52                	push   $0x52
  jmp alltraps
80105e2c:	e9 78 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e31:	6a 00                	push   $0x0
  pushl $83
80105e33:	6a 53                	push   $0x53
  jmp alltraps
80105e35:	e9 6f f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e3a:	6a 00                	push   $0x0
  pushl $84
80105e3c:	6a 54                	push   $0x54
  jmp alltraps
80105e3e:	e9 66 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e43:	6a 00                	push   $0x0
  pushl $85
80105e45:	6a 55                	push   $0x55
  jmp alltraps
80105e47:	e9 5d f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e4c:	6a 00                	push   $0x0
  pushl $86
80105e4e:	6a 56                	push   $0x56
  jmp alltraps
80105e50:	e9 54 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e55:	6a 00                	push   $0x0
  pushl $87
80105e57:	6a 57                	push   $0x57
  jmp alltraps
80105e59:	e9 4b f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e5e:	6a 00                	push   $0x0
  pushl $88
80105e60:	6a 58                	push   $0x58
  jmp alltraps
80105e62:	e9 42 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e67:	6a 00                	push   $0x0
  pushl $89
80105e69:	6a 59                	push   $0x59
  jmp alltraps
80105e6b:	e9 39 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e70:	6a 00                	push   $0x0
  pushl $90
80105e72:	6a 5a                	push   $0x5a
  jmp alltraps
80105e74:	e9 30 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e79:	6a 00                	push   $0x0
  pushl $91
80105e7b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e7d:	e9 27 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e82:	6a 00                	push   $0x0
  pushl $92
80105e84:	6a 5c                	push   $0x5c
  jmp alltraps
80105e86:	e9 1e f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e8b:	6a 00                	push   $0x0
  pushl $93
80105e8d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e8f:	e9 15 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e94:	6a 00                	push   $0x0
  pushl $94
80105e96:	6a 5e                	push   $0x5e
  jmp alltraps
80105e98:	e9 0c f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e9d:	6a 00                	push   $0x0
  pushl $95
80105e9f:	6a 5f                	push   $0x5f
  jmp alltraps
80105ea1:	e9 03 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105ea6:	6a 00                	push   $0x0
  pushl $96
80105ea8:	6a 60                	push   $0x60
  jmp alltraps
80105eaa:	e9 fa f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eaf:	6a 00                	push   $0x0
  pushl $97
80105eb1:	6a 61                	push   $0x61
  jmp alltraps
80105eb3:	e9 f1 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eb8:	6a 00                	push   $0x0
  pushl $98
80105eba:	6a 62                	push   $0x62
  jmp alltraps
80105ebc:	e9 e8 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ec1:	6a 00                	push   $0x0
  pushl $99
80105ec3:	6a 63                	push   $0x63
  jmp alltraps
80105ec5:	e9 df f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eca:	6a 00                	push   $0x0
  pushl $100
80105ecc:	6a 64                	push   $0x64
  jmp alltraps
80105ece:	e9 d6 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ed3:	6a 00                	push   $0x0
  pushl $101
80105ed5:	6a 65                	push   $0x65
  jmp alltraps
80105ed7:	e9 cd f7 ff ff       	jmp    801056a9 <alltraps>
...
80105edc:	6a 00                	push   $0x0
  pushl $102
80105ede:	6a 66                	push   $0x66
  jmp alltraps
80105ee0:	e9 c4 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ee5:	6a 00                	push   $0x0
  pushl $103
80105ee7:	6a 67                	push   $0x67
  jmp alltraps
80105ee9:	e9 bb f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eee:	6a 00                	push   $0x0
  pushl $104
80105ef0:	6a 68                	push   $0x68
  jmp alltraps
80105ef2:	e9 b2 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ef7:	6a 00                	push   $0x0
  pushl $105
80105ef9:	6a 69                	push   $0x69
  jmp alltraps
80105efb:	e9 a9 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f00:	6a 00                	push   $0x0
  pushl $106
80105f02:	6a 6a                	push   $0x6a
  jmp alltraps
80105f04:	e9 a0 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f09:	6a 00                	push   $0x0
  pushl $107
80105f0b:	6a 6b                	push   $0x6b
  jmp alltraps
80105f0d:	e9 97 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f12:	6a 00                	push   $0x0
  pushl $108
80105f14:	6a 6c                	push   $0x6c
  jmp alltraps
80105f16:	e9 8e f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f1b:	6a 00                	push   $0x0
  pushl $109
80105f1d:	6a 6d                	push   $0x6d
  jmp alltraps
80105f1f:	e9 85 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f24:	6a 00                	push   $0x0
  pushl $110
80105f26:	6a 6e                	push   $0x6e
  jmp alltraps
80105f28:	e9 7c f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f2d:	6a 00                	push   $0x0
  pushl $111
80105f2f:	6a 6f                	push   $0x6f
  jmp alltraps
80105f31:	e9 73 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f36:	6a 00                	push   $0x0
  pushl $112
80105f38:	6a 70                	push   $0x70
  jmp alltraps
80105f3a:	e9 6a f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f3f:	6a 00                	push   $0x0
  pushl $113
80105f41:	6a 71                	push   $0x71
  jmp alltraps
80105f43:	e9 61 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f48:	6a 00                	push   $0x0
  pushl $114
80105f4a:	6a 72                	push   $0x72
  jmp alltraps
80105f4c:	e9 58 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f51:	6a 00                	push   $0x0
  pushl $115
80105f53:	6a 73                	push   $0x73
  jmp alltraps
80105f55:	e9 4f f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f5a:	6a 00                	push   $0x0
  pushl $116
80105f5c:	6a 74                	push   $0x74
  jmp alltraps
80105f5e:	e9 46 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f63:	6a 00                	push   $0x0
  pushl $117
80105f65:	6a 75                	push   $0x75
  jmp alltraps
80105f67:	e9 3d f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f6c:	6a 00                	push   $0x0
  pushl $118
80105f6e:	6a 76                	push   $0x76
  jmp alltraps
80105f70:	e9 34 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f75:	6a 00                	push   $0x0
  pushl $119
80105f77:	6a 77                	push   $0x77
  jmp alltraps
80105f79:	e9 2b f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f7e:	6a 00                	push   $0x0
  pushl $120
80105f80:	6a 78                	push   $0x78
  jmp alltraps
80105f82:	e9 22 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f87:	6a 00                	push   $0x0
  pushl $121
80105f89:	6a 79                	push   $0x79
  jmp alltraps
80105f8b:	e9 19 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f90:	6a 00                	push   $0x0
  pushl $122
80105f92:	6a 7a                	push   $0x7a
  jmp alltraps
80105f94:	e9 10 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f99:	6a 00                	push   $0x0
  pushl $123
80105f9b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f9d:	e9 07 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105fa2:	6a 00                	push   $0x0
  pushl $124
80105fa4:	6a 7c                	push   $0x7c
  jmp alltraps
80105fa6:	e9 fe f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fab:	6a 00                	push   $0x0
  pushl $125
80105fad:	6a 7d                	push   $0x7d
  jmp alltraps
80105faf:	e9 f5 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fb4:	6a 00                	push   $0x0
  pushl $126
80105fb6:	6a 7e                	push   $0x7e
  jmp alltraps
80105fb8:	e9 ec f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fbd:	6a 00                	push   $0x0
  pushl $127
80105fbf:	6a 7f                	push   $0x7f
  jmp alltraps
80105fc1:	e9 e3 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fc8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fcd:	e9 d7 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fd2:	6a 00                	push   $0x0
  pushl $129
80105fd4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fd9:	e9 cb f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fde:	6a 00                	push   $0x0
  pushl $130
80105fe0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fe5:	e9 bf f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fea:	6a 00                	push   $0x0
  pushl $131
80105fec:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105ff1:	e9 b3 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105ff6:	6a 00                	push   $0x0
  pushl $132
80105ff8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ffd:	e9 a7 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106002:	6a 00                	push   $0x0
  pushl $133
80106004:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106009:	e9 9b f6 ff ff       	jmp    801056a9 <alltraps>
...
8010600e:	6a 00                	push   $0x0
  pushl $134
80106010:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106015:	e9 8f f6 ff ff       	jmp    801056a9 <alltraps>
...
8010601a:	6a 00                	push   $0x0
  pushl $135
8010601c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106021:	e9 83 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106026:	6a 00                	push   $0x0
  pushl $136
80106028:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010602d:	e9 77 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106032:	6a 00                	push   $0x0
  pushl $137
80106034:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106039:	e9 6b f6 ff ff       	jmp    801056a9 <alltraps>
...
8010603e:	6a 00                	push   $0x0
  pushl $138
80106040:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106045:	e9 5f f6 ff ff       	jmp    801056a9 <alltraps>
...
8010604a:	6a 00                	push   $0x0
  pushl $139
8010604c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106051:	e9 53 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106056:	6a 00                	push   $0x0
  pushl $140
80106058:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010605d:	e9 47 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106062:	6a 00                	push   $0x0
  pushl $141
80106064:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106069:	e9 3b f6 ff ff       	jmp    801056a9 <alltraps>
...
8010606e:	6a 00                	push   $0x0
  pushl $142
80106070:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106075:	e9 2f f6 ff ff       	jmp    801056a9 <alltraps>
...
8010607a:	6a 00                	push   $0x0
  pushl $143
8010607c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106081:	e9 23 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106086:	6a 00                	push   $0x0
  pushl $144
80106088:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010608d:	e9 17 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106092:	6a 00                	push   $0x0
  pushl $145
80106094:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106099:	e9 0b f6 ff ff       	jmp    801056a9 <alltraps>
...
8010609e:	6a 00                	push   $0x0
  pushl $146
801060a0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060a5:	e9 ff f5 ff ff       	jmp    801056a9 <alltraps>
...
801060aa:	6a 00                	push   $0x0
  pushl $147
801060ac:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060b1:	e9 f3 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060b6:	6a 00                	push   $0x0
  pushl $148
801060b8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060bd:	e9 e7 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060c2:	6a 00                	push   $0x0
  pushl $149
801060c4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060c9:	e9 db f5 ff ff       	jmp    801056a9 <alltraps>
...
801060ce:	6a 00                	push   $0x0
  pushl $150
801060d0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060d5:	e9 cf f5 ff ff       	jmp    801056a9 <alltraps>
...
801060da:	6a 00                	push   $0x0
  pushl $151
801060dc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060e1:	e9 c3 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060e6:	6a 00                	push   $0x0
  pushl $152
801060e8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060ed:	e9 b7 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060f2:	6a 00                	push   $0x0
  pushl $153
801060f4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060f9:	e9 ab f5 ff ff       	jmp    801056a9 <alltraps>
...
801060fe:	6a 00                	push   $0x0
  pushl $154
80106100:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106105:	e9 9f f5 ff ff       	jmp    801056a9 <alltraps>
...
8010610a:	6a 00                	push   $0x0
  pushl $155
8010610c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106111:	e9 93 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106116:	6a 00                	push   $0x0
  pushl $156
80106118:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010611d:	e9 87 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106122:	6a 00                	push   $0x0
  pushl $157
80106124:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106129:	e9 7b f5 ff ff       	jmp    801056a9 <alltraps>
...
8010612e:	6a 00                	push   $0x0
  pushl $158
80106130:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106135:	e9 6f f5 ff ff       	jmp    801056a9 <alltraps>
...
8010613a:	6a 00                	push   $0x0
  pushl $159
8010613c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106141:	e9 63 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106146:	6a 00                	push   $0x0
  pushl $160
80106148:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010614d:	e9 57 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106152:	6a 00                	push   $0x0
  pushl $161
80106154:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106159:	e9 4b f5 ff ff       	jmp    801056a9 <alltraps>
...
8010615e:	6a 00                	push   $0x0
  pushl $162
80106160:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106165:	e9 3f f5 ff ff       	jmp    801056a9 <alltraps>
...
8010616a:	6a 00                	push   $0x0
  pushl $163
8010616c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106171:	e9 33 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106176:	6a 00                	push   $0x0
  pushl $164
80106178:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010617d:	e9 27 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106182:	6a 00                	push   $0x0
  pushl $165
80106184:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106189:	e9 1b f5 ff ff       	jmp    801056a9 <alltraps>
...
8010618e:	6a 00                	push   $0x0
  pushl $166
80106190:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106195:	e9 0f f5 ff ff       	jmp    801056a9 <alltraps>
...
8010619a:	6a 00                	push   $0x0
  pushl $167
8010619c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061a1:	e9 03 f5 ff ff       	jmp    801056a9 <alltraps>
...
801061a6:	6a 00                	push   $0x0
  pushl $168
801061a8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ad:	e9 f7 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061b2:	6a 00                	push   $0x0
  pushl $169
801061b4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061b9:	e9 eb f4 ff ff       	jmp    801056a9 <alltraps>
...
801061be:	6a 00                	push   $0x0
  pushl $170
801061c0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061c5:	e9 df f4 ff ff       	jmp    801056a9 <alltraps>
...
801061ca:	6a 00                	push   $0x0
  pushl $171
801061cc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061d1:	e9 d3 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061d6:	6a 00                	push   $0x0
  pushl $172
801061d8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061dd:	e9 c7 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061e2:	6a 00                	push   $0x0
  pushl $173
801061e4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061e9:	e9 bb f4 ff ff       	jmp    801056a9 <alltraps>
...
801061ee:	6a 00                	push   $0x0
  pushl $174
801061f0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061f5:	e9 af f4 ff ff       	jmp    801056a9 <alltraps>
...
801061fa:	6a 00                	push   $0x0
  pushl $175
801061fc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106201:	e9 a3 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106206:	6a 00                	push   $0x0
  pushl $176
80106208:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010620d:	e9 97 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106212:	6a 00                	push   $0x0
  pushl $177
80106214:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106219:	e9 8b f4 ff ff       	jmp    801056a9 <alltraps>
...
8010621e:	6a 00                	push   $0x0
  pushl $178
80106220:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106225:	e9 7f f4 ff ff       	jmp    801056a9 <alltraps>
...
8010622a:	6a 00                	push   $0x0
  pushl $179
8010622c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106231:	e9 73 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106236:	6a 00                	push   $0x0
  pushl $180
80106238:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010623d:	e9 67 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106242:	6a 00                	push   $0x0
  pushl $181
80106244:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106249:	e9 5b f4 ff ff       	jmp    801056a9 <alltraps>
...
8010624e:	6a 00                	push   $0x0
  pushl $182
80106250:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106255:	e9 4f f4 ff ff       	jmp    801056a9 <alltraps>
...
8010625a:	6a 00                	push   $0x0
  pushl $183
8010625c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106261:	e9 43 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106266:	6a 00                	push   $0x0
  pushl $184
80106268:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010626d:	e9 37 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106272:	6a 00                	push   $0x0
  pushl $185
80106274:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106279:	e9 2b f4 ff ff       	jmp    801056a9 <alltraps>
...
8010627e:	6a 00                	push   $0x0
  pushl $186
80106280:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106285:	e9 1f f4 ff ff       	jmp    801056a9 <alltraps>
...
8010628a:	6a 00                	push   $0x0
  pushl $187
8010628c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106291:	e9 13 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106296:	6a 00                	push   $0x0
  pushl $188
80106298:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010629d:	e9 07 f4 ff ff       	jmp    801056a9 <alltraps>
...
801062a2:	6a 00                	push   $0x0
  pushl $189
801062a4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062a9:	e9 fb f3 ff ff       	jmp    801056a9 <alltraps>
...
801062ae:	6a 00                	push   $0x0
  pushl $190
801062b0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062b5:	e9 ef f3 ff ff       	jmp    801056a9 <alltraps>
...
801062ba:	6a 00                	push   $0x0
  pushl $191
801062bc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062c1:	e9 e3 f3 ff ff       	jmp    801056a9 <alltraps>
...
801062c6:	6a 00                	push   $0x0
  pushl $192
801062c8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062cd:	e9 d7 f3 ff ff       	jmp    801056a9 <alltraps>
...
801062d2:	6a 00                	push   $0x0
  pushl $193
801062d4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062d9:	e9 cb f3 ff ff       	jmp    801056a9 <alltraps>
...
801062de:	6a 00                	push   $0x0
  pushl $194
801062e0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062e5:	e9 bf f3 ff ff       	jmp    801056a9 <alltraps>
...
801062ea:	6a 00                	push   $0x0
  pushl $195
801062ec:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062f1:	e9 b3 f3 ff ff       	jmp    801056a9 <alltraps>
...
801062f6:	6a 00                	push   $0x0
  pushl $196
801062f8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062fd:	e9 a7 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106302:	6a 00                	push   $0x0
  pushl $197
80106304:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106309:	e9 9b f3 ff ff       	jmp    801056a9 <alltraps>
...
8010630e:	6a 00                	push   $0x0
  pushl $198
80106310:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106315:	e9 8f f3 ff ff       	jmp    801056a9 <alltraps>
...
8010631a:	6a 00                	push   $0x0
  pushl $199
8010631c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106321:	e9 83 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106326:	6a 00                	push   $0x0
  pushl $200
80106328:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010632d:	e9 77 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106332:	6a 00                	push   $0x0
  pushl $201
80106334:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106339:	e9 6b f3 ff ff       	jmp    801056a9 <alltraps>
...
8010633e:	6a 00                	push   $0x0
  pushl $202
80106340:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106345:	e9 5f f3 ff ff       	jmp    801056a9 <alltraps>
...
8010634a:	6a 00                	push   $0x0
  pushl $203
8010634c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106351:	e9 53 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106356:	6a 00                	push   $0x0
  pushl $204
80106358:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010635d:	e9 47 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106362:	6a 00                	push   $0x0
  pushl $205
80106364:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106369:	e9 3b f3 ff ff       	jmp    801056a9 <alltraps>
...
8010636e:	6a 00                	push   $0x0
  pushl $206
80106370:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106375:	e9 2f f3 ff ff       	jmp    801056a9 <alltraps>
...
8010637a:	6a 00                	push   $0x0
  pushl $207
8010637c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106381:	e9 23 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106386:	6a 00                	push   $0x0
  pushl $208
80106388:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010638d:	e9 17 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106392:	6a 00                	push   $0x0
  pushl $209
80106394:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106399:	e9 0b f3 ff ff       	jmp    801056a9 <alltraps>
...
8010639e:	6a 00                	push   $0x0
  pushl $210
801063a0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063a5:	e9 ff f2 ff ff       	jmp    801056a9 <alltraps>
...
801063aa:	6a 00                	push   $0x0
  pushl $211
801063ac:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063b1:	e9 f3 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063b6:	6a 00                	push   $0x0
  pushl $212
801063b8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063bd:	e9 e7 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063c2:	6a 00                	push   $0x0
  pushl $213
801063c4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063c9:	e9 db f2 ff ff       	jmp    801056a9 <alltraps>
...
801063ce:	6a 00                	push   $0x0
  pushl $214
801063d0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063d5:	e9 cf f2 ff ff       	jmp    801056a9 <alltraps>
...
801063da:	6a 00                	push   $0x0
  pushl $215
801063dc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063e1:	e9 c3 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063e6:	6a 00                	push   $0x0
  pushl $216
801063e8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063ed:	e9 b7 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063f2:	6a 00                	push   $0x0
  pushl $217
801063f4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063f9:	e9 ab f2 ff ff       	jmp    801056a9 <alltraps>
...
801063fe:	6a 00                	push   $0x0
  pushl $218
80106400:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106405:	e9 9f f2 ff ff       	jmp    801056a9 <alltraps>
...
8010640a:	6a 00                	push   $0x0
  pushl $219
8010640c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106411:	e9 93 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106416:	6a 00                	push   $0x0
  pushl $220
80106418:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010641d:	e9 87 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106422:	6a 00                	push   $0x0
  pushl $221
80106424:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106429:	e9 7b f2 ff ff       	jmp    801056a9 <alltraps>
...
8010642e:	6a 00                	push   $0x0
  pushl $222
80106430:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106435:	e9 6f f2 ff ff       	jmp    801056a9 <alltraps>
...
8010643a:	6a 00                	push   $0x0
  pushl $223
8010643c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106441:	e9 63 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106446:	6a 00                	push   $0x0
  pushl $224
80106448:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010644d:	e9 57 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106452:	6a 00                	push   $0x0
  pushl $225
80106454:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106459:	e9 4b f2 ff ff       	jmp    801056a9 <alltraps>
...
8010645e:	6a 00                	push   $0x0
  pushl $226
80106460:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106465:	e9 3f f2 ff ff       	jmp    801056a9 <alltraps>
...
8010646a:	6a 00                	push   $0x0
  pushl $227
8010646c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106471:	e9 33 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106476:	6a 00                	push   $0x0
  pushl $228
80106478:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010647d:	e9 27 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106482:	6a 00                	push   $0x0
  pushl $229
80106484:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106489:	e9 1b f2 ff ff       	jmp    801056a9 <alltraps>
...
8010648e:	6a 00                	push   $0x0
  pushl $230
80106490:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106495:	e9 0f f2 ff ff       	jmp    801056a9 <alltraps>
...
8010649a:	6a 00                	push   $0x0
  pushl $231
8010649c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064a1:	e9 03 f2 ff ff       	jmp    801056a9 <alltraps>
...
801064a6:	6a 00                	push   $0x0
  pushl $232
801064a8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ad:	e9 f7 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064b2:	6a 00                	push   $0x0
  pushl $233
801064b4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064b9:	e9 eb f1 ff ff       	jmp    801056a9 <alltraps>
...
801064be:	6a 00                	push   $0x0
  pushl $234
801064c0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064c5:	e9 df f1 ff ff       	jmp    801056a9 <alltraps>
...
801064ca:	6a 00                	push   $0x0
  pushl $235
801064cc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064d1:	e9 d3 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064d6:	6a 00                	push   $0x0
  pushl $236
801064d8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064dd:	e9 c7 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064e2:	6a 00                	push   $0x0
  pushl $237
801064e4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064e9:	e9 bb f1 ff ff       	jmp    801056a9 <alltraps>
...
801064ee:	6a 00                	push   $0x0
  pushl $238
801064f0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064f5:	e9 af f1 ff ff       	jmp    801056a9 <alltraps>
...
801064fa:	6a 00                	push   $0x0
  pushl $239
801064fc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106501:	e9 a3 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106506:	6a 00                	push   $0x0
  pushl $240
80106508:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010650d:	e9 97 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106512:	6a 00                	push   $0x0
  pushl $241
80106514:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106519:	e9 8b f1 ff ff       	jmp    801056a9 <alltraps>
...
8010651e:	6a 00                	push   $0x0
  pushl $242
80106520:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106525:	e9 7f f1 ff ff       	jmp    801056a9 <alltraps>
...
8010652a:	6a 00                	push   $0x0
  pushl $243
8010652c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106531:	e9 73 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106536:	6a 00                	push   $0x0
  pushl $244
80106538:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010653d:	e9 67 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106542:	6a 00                	push   $0x0
  pushl $245
80106544:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106549:	e9 5b f1 ff ff       	jmp    801056a9 <alltraps>
...
8010654e:	6a 00                	push   $0x0
  pushl $246
80106550:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106555:	e9 4f f1 ff ff       	jmp    801056a9 <alltraps>
...
8010655a:	6a 00                	push   $0x0
  pushl $247
8010655c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106561:	e9 43 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106566:	6a 00                	push   $0x0
  pushl $248
80106568:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010656d:	e9 37 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106572:	6a 00                	push   $0x0
  pushl $249
80106574:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106579:	e9 2b f1 ff ff       	jmp    801056a9 <alltraps>
...
8010657e:	6a 00                	push   $0x0
  pushl $250
80106580:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106585:	e9 1f f1 ff ff       	jmp    801056a9 <alltraps>
...
8010658a:	6a 00                	push   $0x0
  pushl $251
8010658c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106591:	e9 13 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106596:	6a 00                	push   $0x0
  pushl $252
80106598:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010659d:	e9 07 f1 ff ff       	jmp    801056a9 <alltraps>
...
801065a2:	6a 00                	push   $0x0
  pushl $253
801065a4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065a9:	e9 fb f0 ff ff       	jmp    801056a9 <alltraps>
...
801065ae:	6a 00                	push   $0x0
  pushl $254
801065b0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065b5:	e9 ef f0 ff ff       	jmp    801056a9 <alltraps>
...
801065ba:	6a 00                	push   $0x0
  pushl $255
801065bc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065c1:	e9 e3 f0 ff ff       	jmp    801056a9 <alltraps>
801065c6:	66 90                	xchg   %ax,%ax
801065c8:	66 90                	xchg   %ax,%ax
...
801065d5:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801065d7:	c1 ea 16             	shr    $0x16,%edx
{
801065da:	53                   	push   %ebx
  pde = &pgdir[PDX(va)];
801065db:	8d 3c 90             	lea    (%eax,%edx,4),%edi
{
801065de:	83 ec 1c             	sub    $0x1c,%esp
  if(*pde & PTE_P){
801065e1:	8b 1f                	mov    (%edi),%ebx
801065e3:	f6 c3 01             	test   $0x1,%bl
801065e6:	74 28                	je     80106610 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801065e8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801065ee:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
801065f4:	c1 ee 0a             	shr    $0xa,%esi
}
801065f7:	83 c4 1c             	add    $0x1c,%esp
  return &pgtab[PTX(va)];
801065fa:	89 f2                	mov    %esi,%edx
...
80106612:	74 34                	je     80106648 <walkpgdir+0x78>
80106614:	e8 87 be ff ff       	call   801024a0 <kalloc>
80106619:	85 c0                	test   %eax,%eax
8010661b:	89 c3                	mov    %eax,%ebx
8010661d:	74 29                	je     80106648 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
8010661f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106626:	00 
80106627:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010662e:	00 
8010662f:	89 04 24             	mov    %eax,(%esp)
80106632:	e8 69 de ff ff       	call   801044a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106637:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010663d:	83 c8 07             	or     $0x7,%eax
80106640:	89 07                	mov    %eax,(%edi)
80106642:	eb b0                	jmp    801065f4 <walkpgdir+0x24>
...
8010666b:	8b 7d 08             	mov    0x8(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
8010666e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
80106674:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106677:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
8010667b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
8010667e:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106682:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
80106689:	29 df                	sub    %ebx,%edi
8010668b:	eb 18                	jmp    801066a5 <mappages+0x45>
8010668d:	8d 76 00             	lea    0x0(%esi),%esi
    if(*pte & PTE_P)
80106690:	f6 00 01             	testb  $0x1,(%eax)
80106693:	75 3d                	jne    801066d2 <mappages+0x72>
    *pte = pa | perm | PTE_P;
80106695:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
80106698:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
8010669b:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010669d:	74 29                	je     801066c8 <mappages+0x68>
      break;
    a += PGSIZE;
8010669f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801066a5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801066a8:	b9 01 00 00 00       	mov    $0x1,%ecx
801066ad:	89 da                	mov    %ebx,%edx
801066af:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
801066b2:	e8 19 ff ff ff       	call   801065d0 <walkpgdir>
...
801066bb:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
801066d1:	c3                   	ret    
      panic("remap");
801066d2:	c7 04 24 b4 77 10 80 	movl   $0x801077b4,(%esp)
801066d9:	e8 82 9c ff ff       	call   80100360 <panic>
...
801066e9:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
801066ea:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
801066f0:	83 ec 1c             	sub    $0x1c,%esp
  a = PGROUNDUP(newsz);
801066f3:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801066f9:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
801066fb:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801066fe:	72 3b                	jb     8010673b <deallocuvm.part.0+0x5b>
80106700:	eb 5e                	jmp    80106760 <deallocuvm.part.0+0x80>
...
8010670d:	74 22                	je     80106731 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010670f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106715:	74 54                	je     8010676b <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106717:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010671d:	89 14 24             	mov    %edx,(%esp)
80106720:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106723:	e8 c8 bb ff ff       	call   801022f0 <kfree>
      *pte = 0;
80106728:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010672b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80106731:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106737:	39 f3                	cmp    %esi,%ebx
80106739:	73 25                	jae    80106760 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010673b:	31 c9                	xor    %ecx,%ecx
8010673d:	89 da                	mov    %ebx,%edx
8010673f:	89 f8                	mov    %edi,%eax
80106741:	e8 8a fe ff ff       	call   801065d0 <walkpgdir>
    if(!pte)
80106746:	85 c0                	test   %eax,%eax
80106748:	75 be                	jne    80106708 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010674a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106750:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106756:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010675c:	39 f3                	cmp    %esi,%ebx
8010675e:	72 db                	jb     8010673b <deallocuvm.part.0+0x5b>
    }
  }
  return newsz;
}
80106760:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106763:	83 c4 1c             	add    $0x1c,%esp
80106766:	5b                   	pop    %ebx
80106767:	5e                   	pop    %esi
80106768:	5f                   	pop    %edi
80106769:	5d                   	pop    %ebp
8010676a:	c3                   	ret    
        panic("kfree");
8010676b:	c7 04 24 46 71 10 80 	movl   $0x80107146,(%esp)
80106772:	e8 e9 9b ff ff       	call   80100360 <panic>
...
80106783:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106786:	e8 05 cf ff ff       	call   80103690 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010678b:	31 c9                	xor    %ecx,%ecx
8010678d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c = &cpus[cpuid()];
80106792:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106798:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010679d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067a1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  lgdt(c->gdt, sizeof(c->gdt));
801067a6:	83 c0 70             	add    $0x70,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067a9:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067ad:	31 c9                	xor    %ecx,%ecx
801067af:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067b3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067b8:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067bc:	31 c9                	xor    %ecx,%ecx
801067be:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067c2:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067c7:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067cb:	31 c9                	xor    %ecx,%ecx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067cd:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
801067d1:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067d5:	c6 40 15 92          	movb   $0x92,0x15(%eax)
801067d9:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067dd:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
801067e1:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067e5:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
801067e9:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
801067ed:	66 89 50 20          	mov    %dx,0x20(%eax)
  pd[0] = size-1;
801067f1:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067f6:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
801067fa:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067fe:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106802:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106806:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010680a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010680e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106812:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106816:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010681a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010681e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106822:	c1 e8 10             	shr    $0x10,%eax
80106825:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106829:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010682c:	0f 01 10             	lgdtl  (%eax)
}
8010682f:	c9                   	leave  
80106830:	c3                   	ret    
80106831:	eb 0d                	jmp    80106840 <switchkvm>
80106833:	90                   	nop
80106834:	90                   	nop
80106835:	90                   	nop
80106836:	90                   	nop
...
80106840:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106884:	0f 84 c3 00 00 00    	je     8010694d <switchuvm+0xed>
  pushcli();
8010688a:	e8 61 da ff ff       	call   801042f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010688f:	e8 7c cd ff ff       	call   80103610 <mycpu>
80106894:	89 c3                	mov    %eax,%ebx
80106896:	e8 75 cd ff ff       	call   80103610 <mycpu>
8010689b:	89 c7                	mov    %eax,%edi
8010689d:	e8 6e cd ff ff       	call   80103610 <mycpu>
801068a2:	83 c7 08             	add    $0x8,%edi
801068a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068a8:	e8 63 cd ff ff       	call   80103610 <mycpu>
801068ad:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801068b0:	ba 67 00 00 00       	mov    $0x67,%edx
801068b5:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
801068bc:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
801068c3:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
801068ca:	83 c1 08             	add    $0x8,%ecx
801068cd:	c1 e9 10             	shr    $0x10,%ecx
801068d0:	83 c0 08             	add    $0x8,%eax
801068d3:	c1 e8 18             	shr    $0x18,%eax
801068d6:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801068dc:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
801068e3:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801068e9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
801068ee:	e8 1d cd ff ff       	call   80103610 <mycpu>
801068f3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801068fa:	e8 11 cd ff ff       	call   80103610 <mycpu>
801068ff:	b9 10 00 00 00       	mov    $0x10,%ecx
80106904:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106908:	e8 03 cd ff ff       	call   80103610 <mycpu>
8010690d:	8b 56 08             	mov    0x8(%esi),%edx
80106910:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106916:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106919:	e8 f2 cc ff ff       	call   80103610 <mycpu>
...
8010693b:	5d                   	pop    %ebp
  popcli();
8010693c:	e9 ef d9 ff ff       	jmp    80104330 <popcli>
    panic("switchuvm: no process");
80106941:	c7 04 24 ba 77 10 80 	movl   $0x801077ba,(%esp)
80106948:	e8 13 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010694d:	c7 04 24 e5 77 10 80 	movl   $0x801077e5,(%esp)
80106954:	e8 07 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106959:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
80106960:	e8 fb 99 ff ff       	call   80100360 <panic>
80106965:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106988:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
8010698b:	77 54                	ja     801069e1 <inituvm+0x71>
  mem = kalloc();
8010698d:	e8 0e bb ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
80106992:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106999:	00 
8010699a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069a1:	00 
  mem = kalloc();
801069a2:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801069a4:	89 04 24             	mov    %eax,(%esp)
801069a7:	e8 f4 da ff ff       	call   801044a0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801069ac:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801069b2:	b9 00 10 00 00       	mov    $0x1000,%ecx
801069b7:	89 04 24             	mov    %eax,(%esp)
801069ba:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801069bd:	31 d2                	xor    %edx,%edx
801069bf:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
801069c6:	00 
801069c7:	e8 94 fc ff ff       	call   80106660 <mappages>
  memmove(mem, init, sz);
801069cc:	89 75 10             	mov    %esi,0x10(%ebp)
801069cf:	89 7d 0c             	mov    %edi,0xc(%ebp)
801069d2:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
801069d5:	83 c4 1c             	add    $0x1c,%esp
801069d8:	5b                   	pop    %ebx
801069d9:	5e                   	pop    %esi
801069da:	5f                   	pop    %edi
801069db:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069dc:	e9 5f db ff ff       	jmp    80104540 <memmove>
    panic("inituvm: more than a page");
801069e1:	c7 04 24 f9 77 10 80 	movl   $0x801077f9,(%esp)
801069e8:	e8 73 99 ff ff       	call   80100360 <panic>
...
80106a00:	0f 85 98 00 00 00    	jne    80106a9e <loaduvm+0xae>
...
80106a0f:	eb 77                	jmp    80106a88 <loaduvm+0x98>
...
80106a27:	76 5f                	jbe    80106a88 <loaduvm+0x98>
80106a29:	8b 55 0c             	mov    0xc(%ebp),%edx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106a2c:	31 c9                	xor    %ecx,%ecx
80106a2e:	8b 45 08             	mov    0x8(%ebp),%eax
80106a31:	01 da                	add    %ebx,%edx
80106a33:	e8 98 fb ff ff       	call   801065d0 <walkpgdir>
80106a38:	85 c0                	test   %eax,%eax
80106a3a:	74 56                	je     80106a92 <loaduvm+0xa2>
    pa = PTE_ADDR(*pte);
80106a3c:	8b 00                	mov    (%eax),%eax
      n = PGSIZE;
80106a3e:	bf 00 10 00 00       	mov    $0x1000,%edi
80106a43:	8b 4d 14             	mov    0x14(%ebp),%ecx
    pa = PTE_ADDR(*pte);
80106a46:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      n = PGSIZE;
80106a4b:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80106a51:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106a54:	05 00 00 00 80       	add    $0x80000000,%eax
80106a59:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a5d:	8b 45 10             	mov    0x10(%ebp),%eax
80106a60:	01 d9                	add    %ebx,%ecx
80106a62:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106a66:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a6a:	89 04 24             	mov    %eax,(%esp)
80106a6d:	e8 ee ae ff ff       	call   80101960 <readi>
80106a72:	39 f8                	cmp    %edi,%eax
80106a74:	74 a2                	je     80106a18 <loaduvm+0x28>
}
80106a76:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106a88:	83 c4 1c             	add    $0x1c,%esp
  return 0;
...
80106a92:	c7 04 24 13 78 10 80 	movl   $0x80107813,(%esp)
80106a99:	e8 c2 98 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106a9e:	c7 04 24 b4 78 10 80 	movl   $0x801078b4,(%esp)
...
80106abe:	0f 88 7e 00 00 00    	js     80106b42 <allocuvm+0x92>
  if(newsz < oldsz)
80106ac4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106ac7:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106aca:	72 78                	jb     80106b44 <allocuvm+0x94>
  a = PGROUNDUP(oldsz);
80106acc:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106ad2:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106ad8:	39 df                	cmp    %ebx,%edi
80106ada:	77 4a                	ja     80106b26 <allocuvm+0x76>
80106adc:	eb 72                	jmp    80106b50 <allocuvm+0xa0>
80106ade:	66 90                	xchg   %ax,%ax
    memset(mem, 0, PGSIZE);
80106ae0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ae7:	00 
80106ae8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106aef:	00 
80106af0:	89 04 24             	mov    %eax,(%esp)
80106af3:	e8 a8 d9 ff ff       	call   801044a0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106af8:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106afe:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b03:	89 04 24             	mov    %eax,(%esp)
80106b06:	8b 45 08             	mov    0x8(%ebp),%eax
80106b09:	89 da                	mov    %ebx,%edx
80106b0b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106b12:	00 
80106b13:	e8 48 fb ff ff       	call   80106660 <mappages>
80106b18:	85 c0                	test   %eax,%eax
80106b1a:	78 44                	js     80106b60 <allocuvm+0xb0>
  for(; a < newsz; a += PGSIZE){
80106b1c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b22:	39 df                	cmp    %ebx,%edi
80106b24:	76 2a                	jbe    80106b50 <allocuvm+0xa0>
    mem = kalloc();
80106b26:	e8 75 b9 ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
80106b2b:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106b2d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106b2f:	75 af                	jne    80106ae0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106b31:	c7 04 24 31 78 10 80 	movl   $0x80107831,(%esp)
80106b38:	e8 13 9b ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106b3d:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b40:	77 48                	ja     80106b8a <allocuvm+0xda>
      return 0;
80106b42:	31 c0                	xor    %eax,%eax
}
80106b44:	83 c4 1c             	add    $0x1c,%esp
80106b47:	5b                   	pop    %ebx
80106b48:	5e                   	pop    %esi
80106b49:	5f                   	pop    %edi
80106b4a:	5d                   	pop    %ebp
...
80106b50:	83 c4 1c             	add    $0x1c,%esp
...
80106b60:	c7 04 24 49 78 10 80 	movl   $0x80107849,(%esp)
80106b67:	e8 e4 9a ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106b6c:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b6f:	76 0d                	jbe    80106b7e <allocuvm+0xce>
80106b71:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b74:	89 fa                	mov    %edi,%edx
80106b76:	8b 45 08             	mov    0x8(%ebp),%eax
80106b79:	e8 62 fb ff ff       	call   801066e0 <deallocuvm.part.0>
      kfree(mem);
80106b7e:	89 34 24             	mov    %esi,(%esp)
80106b81:	e8 6a b7 ff ff       	call   801022f0 <kfree>
      return 0;
80106b86:	31 c0                	xor    %eax,%eax
80106b88:	eb ba                	jmp    80106b44 <allocuvm+0x94>
80106b8a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b8d:	89 fa                	mov    %edi,%edx
80106b8f:	8b 45 08             	mov    0x8(%ebp),%eax
80106b92:	e8 49 fb ff ff       	call   801066e0 <deallocuvm.part.0>
      return 0;
80106b97:	31 c0                	xor    %eax,%eax
80106b99:	eb a9                	jmp    80106b44 <allocuvm+0x94>
80106b9b:	90                   	nop
...
80106bae:	73 08                	jae    80106bb8 <deallocuvm+0x18>
}
80106bb0:	5d                   	pop    %ebp
80106bb1:	e9 2a fb ff ff       	jmp    801066e0 <deallocuvm.part.0>
80106bb6:	66 90                	xchg   %ax,%ax
80106bb8:	89 d0                	mov    %edx,%eax
80106bba:	5d                   	pop    %ebp
80106bbb:	c3                   	ret    
...
80106bc8:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106bcb:	85 f6                	test   %esi,%esi
80106bcd:	74 59                	je     80106c28 <freevm+0x68>
80106bcf:	31 c9                	xor    %ecx,%ecx
80106bd1:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106bd6:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106bd8:	31 db                	xor    %ebx,%ebx
80106bda:	e8 01 fb ff ff       	call   801066e0 <deallocuvm.part.0>
80106bdf:	eb 12                	jmp    80106bf3 <freevm+0x33>
80106be1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106be8:	83 c3 01             	add    $0x1,%ebx
80106beb:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106bf1:	74 27                	je     80106c1a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80106bf3:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80106bf6:	f6 c2 01             	test   $0x1,%dl
80106bf9:	74 ed                	je     80106be8 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106bfb:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  for(i = 0; i < NPDENTRIES; i++){
80106c01:	83 c3 01             	add    $0x1,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c04:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106c0a:	89 14 24             	mov    %edx,(%esp)
80106c0d:	e8 de b6 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80106c12:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c18:	75 d9                	jne    80106bf3 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
80106c22:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106c23:	e9 c8 b6 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106c28:	c7 04 24 65 78 10 80 	movl   $0x80107865,(%esp)
80106c2f:	e8 2c 97 ff ff       	call   80100360 <panic>
...
80106c48:	e8 53 b8 ff ff       	call   801024a0 <kalloc>
80106c4d:	85 c0                	test   %eax,%eax
80106c4f:	89 c6                	mov    %eax,%esi
80106c51:	74 6d                	je     80106cc0 <setupkvm+0x80>
  memset(pgdir, 0, PGSIZE);
80106c53:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c5a:	00 
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106c5b:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106c60:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c67:	00 
80106c68:	89 04 24             	mov    %eax,(%esp)
80106c6b:	e8 30 d8 ff ff       	call   801044a0 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106c70:	8b 53 0c             	mov    0xc(%ebx),%edx
80106c73:	8b 43 04             	mov    0x4(%ebx),%eax
80106c76:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106c79:	89 54 24 04          	mov    %edx,0x4(%esp)
80106c7d:	8b 13                	mov    (%ebx),%edx
80106c7f:	89 04 24             	mov    %eax,(%esp)
80106c82:	29 c1                	sub    %eax,%ecx
80106c84:	89 f0                	mov    %esi,%eax
80106c86:	e8 d5 f9 ff ff       	call   80106660 <mappages>
80106c8b:	85 c0                	test   %eax,%eax
80106c8d:	78 19                	js     80106ca8 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106c8f:	83 c3 10             	add    $0x10,%ebx
80106c92:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106c98:	72 d6                	jb     80106c70 <setupkvm+0x30>
80106c9a:	89 f0                	mov    %esi,%eax
}
...
80106ca4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106ca8:	89 34 24             	mov    %esi,(%esp)
80106cab:	e8 10 ff ff ff       	call   80106bc0 <freevm>
}
...
80106cc2:	eb d8                	jmp    80106c9c <setupkvm+0x5c>
...
80106cd3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106cd6:	e8 65 ff ff ff       	call   80106c40 <setupkvm>
80106cdb:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106cfe:	e8 cd f8 ff ff       	call   801065d0 <walkpgdir>
  if(pte == 0)
...
80106d0b:	c3                   	ret    
    panic("clearpteu");
80106d0c:	c7 04 24 76 78 10 80 	movl   $0x80107876,(%esp)
80106d13:	e8 48 96 ff ff       	call   80100360 <panic>
80106d18:	90                   	nop
...
80106d26:	83 ec 2c             	sub    $0x2c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106d29:	e8 12 ff ff ff       	call   80106c40 <setupkvm>
80106d2e:	85 c0                	test   %eax,%eax
80106d30:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106d33:	0f 84 b9 00 00 00    	je     80106df2 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106d46:	eb 48                	jmp    80106d90 <copyuvm+0x70>
...
80106d48:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106d4e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d55:	00 
80106d56:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d5a:	89 04 24             	mov    %eax,(%esp)
80106d5d:	e8 de d7 ff ff       	call   80104540 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106d62:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d65:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d6a:	89 fa                	mov    %edi,%edx
80106d6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d70:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106d76:	89 04 24             	mov    %eax,(%esp)
80106d79:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d7c:	e8 df f8 ff ff       	call   80106660 <mappages>
80106d81:	85 c0                	test   %eax,%eax
80106d83:	78 63                	js     80106de8 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106d85:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106d8b:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106d8e:	76 48                	jbe    80106dd8 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d90:	8b 45 08             	mov    0x8(%ebp),%eax
80106d93:	31 c9                	xor    %ecx,%ecx
80106d95:	89 fa                	mov    %edi,%edx
80106d97:	e8 34 f8 ff ff       	call   801065d0 <walkpgdir>
80106d9c:	85 c0                	test   %eax,%eax
80106d9e:	74 62                	je     80106e02 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106da0:	8b 00                	mov    (%eax),%eax
80106da2:	a8 01                	test   $0x1,%al
80106da4:	74 50                	je     80106df6 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106da6:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106da8:	25 ff 0f 00 00       	and    $0xfff,%eax
80106dad:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106db0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106db6:	e8 e5 b6 ff ff       	call   801024a0 <kalloc>
80106dbb:	85 c0                	test   %eax,%eax
80106dbd:	89 c3                	mov    %eax,%ebx
80106dbf:	75 87                	jne    80106d48 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106dc1:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106dc4:	89 04 24             	mov    %eax,(%esp)
80106dc7:	e8 f4 fd ff ff       	call   80106bc0 <freevm>
  return 0;
80106dcc:	31 c0                	xor    %eax,%eax
}
80106dce:	83 c4 2c             	add    $0x2c,%esp
80106dd1:	5b                   	pop    %ebx
80106dd2:	5e                   	pop    %esi
80106dd3:	5f                   	pop    %edi
80106dd4:	5d                   	pop    %ebp
...
80106ddb:	83 c4 2c             	add    $0x2c,%esp
80106dde:	5b                   	pop    %ebx
80106ddf:	5e                   	pop    %esi
80106de0:	5f                   	pop    %edi
80106de1:	5d                   	pop    %ebp
...
80106de4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106de8:	89 1c 24             	mov    %ebx,(%esp)
80106deb:	e8 00 b5 ff ff       	call   801022f0 <kfree>
      goto bad;
80106df0:	eb cf                	jmp    80106dc1 <copyuvm+0xa1>
    return 0;
80106df2:	31 c0                	xor    %eax,%eax
80106df4:	eb d8                	jmp    80106dce <copyuvm+0xae>
      panic("copyuvm: page not present");
80106df6:	c7 04 24 9a 78 10 80 	movl   $0x8010789a,(%esp)
80106dfd:	e8 5e 95 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106e02:	c7 04 24 80 78 10 80 	movl   $0x80107880,(%esp)
80106e09:	e8 52 95 ff ff       	call   80100360 <panic>
...
80106e34:	05 00 00 00 80       	add    $0x80000000,%eax
}
80106e39:	c9                   	leave  
80106e3a:	c3                   	ret    
80106e3b:	90                   	nop
...
80106e5c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80106e64:	75 3a                	jne    80106ea0 <copyout+0x50>
80106e66:	eb 68                	jmp    80106ed0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80106e68:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106e6b:	89 f2                	mov    %esi,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106e6d:	89 7c 24 04          	mov    %edi,0x4(%esp)
    n = PGSIZE - (va - va0);
80106e71:	29 ca                	sub    %ecx,%edx
80106e73:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106e79:	39 da                	cmp    %ebx,%edx
80106e7b:	0f 47 d3             	cmova  %ebx,%edx
    memmove(pa0 + (va - va0), buf, n);
80106e7e:	29 f1                	sub    %esi,%ecx
80106e80:	01 c8                	add    %ecx,%eax
80106e82:	89 54 24 08          	mov    %edx,0x8(%esp)
80106e86:	89 04 24             	mov    %eax,(%esp)
80106e89:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106e8c:	e8 af d6 ff ff       	call   80104540 <memmove>
    len -= n;
    buf += n;
80106e91:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    va = va0 + PGSIZE;
80106e94:	8d 8e 00 10 00 00    	lea    0x1000(%esi),%ecx
    buf += n;
80106e9a:	01 d7                	add    %edx,%edi
  while(len > 0){
80106e9c:	29 d3                	sub    %edx,%ebx
80106e9e:	74 30                	je     80106ed0 <copyout+0x80>
    pa0 = uva2ka(pgdir, (char*)va0);
80106ea0:	8b 45 08             	mov    0x8(%ebp),%eax
    va0 = (uint)PGROUNDDOWN(va);
80106ea3:	89 ce                	mov    %ecx,%esi
80106ea5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106eab:	89 74 24 04          	mov    %esi,0x4(%esp)
    va0 = (uint)PGROUNDDOWN(va);
80106eaf:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80106eb2:	89 04 24             	mov    %eax,(%esp)
80106eb5:	e8 56 ff ff ff       	call   80106e10 <uva2ka>
    if(pa0 == 0)
80106eba:	85 c0                	test   %eax,%eax
80106ebc:	75 aa                	jne    80106e68 <copyout+0x18>
  }
  return 0;
}
80106ebe:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106ed0:	83 c4 1c             	add    $0x1c,%esp
  return 0;
